...
- `candidate_parallel_safe_after_provider_audit`: 14 wrappers
- `not_candidate_fortran_io`: 4 wrappers
- `not_candidate_mutable_native_state`: 202 wrappers
- `not_candidate_xerror`: 16 wrappers
