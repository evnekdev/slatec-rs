...
| Hosted runtime | default `std`, plus a numerical-family feature | Runtime-serialized special functions; allocation- and callback-managed quadrature, roots, nonlinear systems, and nonlinear least squares |
