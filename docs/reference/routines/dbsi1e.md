...
DBSI1E(X) calculates the double precision exponentially scaled modified (hyperbolic) Bessel function of the first kind of order one for double precision argument X. The result is I1(X) multiplied by EXP(-ABS(X)). Series for BI1 on the interval 0. to 9.00000E+00
...
significant figures required  31.45 decimal places required  32.46 Series for AI1        on the interval  1.25000E-01 to  3.33333E-01 significant figures required  29.93 decimal places required  32.38 Series for AI12       on the interval  0.          to  1.25000E-01 significant figures required  29.97 decimal places required  32.66
