...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `CA` | `input-output` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | (Complex) (Complex) CA/ABS(CA)*NORM(CA,CB). |
| 2 | `CB` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | (Complex). |
| 3 | `C` | `output` | `scalar` | `REAL` | `*mut f32` | scalar | (Real). |
| 4 | `S` | `output` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | (Complex). |
...
Canonical Rust path: `slatec_sys::blas::level1::crotg`. Native symbol: `crotg_`. Declaration feature: `blas-level1`. Provider feature: `blas-level1`. ABI fingerprint: `unavailable`.
