...
- Canonical provider: `main-src/src/zunk1.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zunk1.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zunk1.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zunk1.f) — `verified_cached`
