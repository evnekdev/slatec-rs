...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `X` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | X AND Y ARE UPDATED TO BE CONSISTENT WITH THE NEW STEP. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `Y` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | X AND Y ARE UPDATED TO BE CONSISTENT WITH THE NEW STEP. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `YPRIME` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | DDAINI TAKES ONE STEP OF SIZE H OR SMALLER WITH THE BACKWARD EULER METHOD, TO FIND YPRIME. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `WT` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `IDID` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `RPAR` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `IPAR` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | rank 1; dimensions (*) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `PHI` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 2; dimensions (NEQ, *) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `DELTA` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `E` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `WM` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | WT -- VECTOR OF WEIGHTS FOR ERROR CRITERION IDID -- COMPLETION CODE WITH THE FOLLOWING MEANINGS IDID= 1 -- YPRIME WAS FOUND SUCCESSFULLY IDID=-12 -- DDAINI FAILED TO FIND YPRIME RPAR,IPAR -- REAL AND INTEGER PARAMETER ARRAYS THAT ARE NOT ALTERED BY DDAINI PHI -- WORK SPACE FOR DDAINI DELTA,E -- WORK SPACE FOR DDAINI WM,IWM -- REAL AND INTEGER ARRAYS STORING MATRIX INFORMATION | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
