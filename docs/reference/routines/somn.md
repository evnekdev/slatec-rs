...
| 21 | `P` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (N, 0:NSAVE) | P(N,0:NSAVE). |
| 22 | `AP` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (N, 0:NSAVE) | AP(N,0:NSAVE). |
| 23 | `EMAP` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (N, 0:NSAVE) | EMAP(N,0:NSAVE). |
| 24 | `DZ` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | DZ(N). |
| 25 | `CSAV` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NSAVE) | CSAV(NSAVE) Real arrays used for workspace. |
| 26 | `RWORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | RWORK(USER DEFINED). array that can be used for workspace in MSOLVE. |
