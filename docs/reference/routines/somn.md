...
| 21 | `P` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (N, 0:NSAVE) | Array argument classified by fixed-form executable read/write analysis. |
| 22 | `AP` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (N, 0:NSAVE) | Array argument classified by fixed-form executable read/write analysis. |
| 23 | `EMAP` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (N, 0:NSAVE) | Array argument classified by fixed-form executable read/write analysis. |
...
| 25 | `CSAV` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NSAVE) | Array argument classified by fixed-form executable read/write analysis. |
