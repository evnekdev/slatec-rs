...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `DX` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | Converts double-precision number DX to multiple-precision Z. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `Z` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | rank 1; dimensions (*) | Converts double-precision number DX to multiple-precision Z. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
