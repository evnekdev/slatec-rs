...
- Exact Netlib source: [SSMMI2](https://www.netlib.org/slatec/lin/ssmmi2.f)
...
| 6 | `L` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | b. b. IL     :IN       Integer IL(NL). IL     :IN       Integer IL(NL). JL     :IN       Integer JL(NL). JL     :IN       Integer JL(NL). L      :IN       Real     L(NL). L      :IN       Real     L(NL). IL, JL, L contain the unit lower  triangular factor of the IL, JL, L contain the unit lower  triangular factor of the incomplete decomposition of some matrix stored in SLAP Row incomplete decomposition of some matrix stored in SLAP Row format.  The diagonal of ones *IS* stored.  This structure format.  The diagonal of ones *IS* stored.  This structure can  be  set  up  by   the  SSILUS   routine.    See   the can  be  set  up  by   the  SSILUS   routine.    See   the "Description", below for  more   details   about  the SLAP "Description", below for  more   details   about  the SLAP format.  (NL is the number of non-zeros in the L array.) format.  (NL is the number of non-zeros in the L array.) DINV   :IN       Real DINV(N). DINV   :IN       Real DINV(N). Inverse of the diagonal matrix D. Inverse of the diagonal matrix D. IU     :IN       Integer IU(NU). IU     :IN       Integer IU(NU). JU     :IN       Integer JU(NU). JU     :IN       Integer JU(NU). U      :IN       Real     U(NU). U      :IN       Real     U(NU). IU, JU, U contain the unit upper  triangular factor of the IU, JU, U contain the unit upper  triangular factor of the incomplete decomposition  of   some matrix stored in  SLAP incomplete decomposition  of   some matrix stored in  SLAP Column  format.  The diagonal  of  ones *IS* stored.  This Column  format.  The diagonal  of  ones *IS* stored.  This structure can be set up  by the SSILUS routine.  See   the structure can be set up  by the SSILUS routine.  See   the "Description",  below  for  more  details  about  the SLAP "Description",  below  for  more  details  about  the SLAP format.  (NU is the number of non-zeros in the U array.) format.  (NU is the number of non-zeros in the U array.) |
| 7 | `DINV` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | Array argument classified by fixed-form executable read/write analysis. |
...
| 10 | `U` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | b. b. IL     :IN       Integer IL(NL). IL     :IN       Integer IL(NL). JL     :IN       Integer JL(NL). JL     :IN       Integer JL(NL). L      :IN       Real     L(NL). L      :IN       Real     L(NL). IL, JL, L contain the unit lower  triangular factor of the IL, JL, L contain the unit lower  triangular factor of the incomplete decomposition of some matrix stored in SLAP Row incomplete decomposition of some matrix stored in SLAP Row format.  The diagonal of ones *IS* stored.  This structure format.  The diagonal of ones *IS* stored.  This structure can  be  set  up  by   the  SSILUS   routine.    See   the can  be  set  up  by   the  SSILUS   routine.    See   the "Description", below for  more   details   about  the SLAP "Description", below for  more   details   about  the SLAP format.  (NL is the number of non-zeros in the L array.) format.  (NL is the number of non-zeros in the L array.) DINV   :IN       Real DINV(N). DINV   :IN       Real DINV(N). Inverse of the diagonal matrix D. Inverse of the diagonal matrix D. IU     :IN       Integer IU(NU). IU     :IN       Integer IU(NU). JU     :IN       Integer JU(NU). JU     :IN       Integer JU(NU). U      :IN       Real     U(NU). U      :IN       Real     U(NU). IU, JU, U contain the unit upper  triangular factor of the IU, JU, U contain the unit upper  triangular factor of the incomplete decomposition  of   some matrix stored in  SLAP incomplete decomposition  of   some matrix stored in  SLAP Column  format.  The diagonal  of  ones *IS* stored.  This Column  format.  The diagonal  of  ones *IS* stored.  This structure can be set up  by the SSILUS routine.  See   the structure can be set up  by the SSILUS routine.  See   the "Description",  below  for  more  details  about  the SLAP "Description",  below  for  more  details  about  the SLAP format.  (NU is the number of non-zeros in the U array.) format.  (NU is the number of non-zeros in the U array.) |
