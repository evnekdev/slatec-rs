...
- Safe Rust paths: `slatec::special::airy::airy_bi`

## Providers

- Canonical provider: `fnlib/dbi.f` (`relocated-subset`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/fnlib/dbi.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/fnlib/dbi.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Input value at which the source-defined function is evaluated: Evaluate the Bairy function (the Airy function of the second kind) |
...
Canonical Rust path: `slatec_sys::special::airy::dbi`. Native symbol: `dbi_`. Declaration feature: `special-airy`. Provider feature: `special-airy`. ABI fingerprint: `unavailable`.
...
- Safe-wrapper status: `slatec::special::airy::airy_bi`
