...
- Exact Netlib source: [DERF](https://www.netlib.org/slatec/fnlib/derf.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Input value at which the source-defined function is evaluated: Compute the error function |
...
Canonical Rust path: `slatec_sys::special::error::derf`. Native symbol: `derf_`. Declaration feature: `special-error`. Provider feature: `special-error`. ABI fingerprint: `unavailable`.
