...
- Canonical provider: `main-src/src/du12ls.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/du12ls.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/du12ls.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/du12ls.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `A` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 2; dimensions (MDA, *) | Given the Householder QR factorization of A, this subroutine solves the system AX=B. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `B` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 2; dimensions (MDB, *) | Given the Householder QR factorization of A, this subroutine solves the system AX=B. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
