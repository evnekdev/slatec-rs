...
| 9 | `WORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(N) a singly subscripted array of dimension at least N. |
