...
| 8 | `IEL` | `output` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (NEL) | Array argument classified by fixed-form executable read/write analysis. |
| 9 | `JEL` | `output` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (NEL) | Array argument classified by fixed-form executable read/write analysis. |
| 10 | `EL` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NELT) | Array argument classified by fixed-form executable read/write analysis. |
