...
| 3 | `X` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | X(N). Solution to L*D*L' x = b. |
...
| 8 | `DINV` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | DINV(N). Inverse of the diagonal matrix D. |
