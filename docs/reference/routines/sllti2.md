...
| 3 | `X` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | B, where L is a unit lower triangular matrix and D is a diagonal matrix and ' means transpose. OUT      Real X(N). b. |
...
| 8 | `DINV` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | IN       Real DINV(N). Inverse of the diagonal matrix D. |
