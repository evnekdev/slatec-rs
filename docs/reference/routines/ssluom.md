...
| 11 | `TOL` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | inv is the inverse of the diagonal of A. |
...
| 14 | `ERR` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Scalar argument classified by fixed-form executable read/write analysis. |
