...
| 9 | `WORK` | `workspace` | `workspace` | `COMPLEX` | `*mut crate::Complex32` | rank 2; dimensions (N, *) | Workspace argument classified by fixed-form executable read/write analysis. |
