...
| 9 | `WORK` | `workspace` | `workspace` | `COMPLEX` | `*mut crate::Complex32` | rank 2; dimensions (N, *) | COMPLEX(N*(NC+1)) a singly subscripted array of dimension at least |
