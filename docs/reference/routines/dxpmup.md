...
- Canonical provider: `main-src/src/dxpmup.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dxpmup.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dxpmup.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dxpmup.f) — `verified_cached`
