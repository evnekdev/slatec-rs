...
DPCHCS: DPCHIC Monotonicity Switch Derivative Setter. Called by DPCHIC to adjust the values of D in the vicinity of a switch in direction of monotonicity, to produce a more "visually pleasing" curve than that given by DPCHIM .
...
- Canonical provider: `pchip/dpchcs.f` (`relocated-subset`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/pchip/dpchcs.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/pchip/dpchcs.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `SWITCH` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | DPCHCS: DPCHIC Monotonicity Switch Derivative Setter. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `D` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 2; dimensions (INCFD, *) | Called by DPCHIC to adjust the values of D in the vicinity of a switch in direction of monotonicity, to produce a more "visually pleasing" curve than that given by DPCHIM . | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
