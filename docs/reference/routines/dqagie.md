...
- Canonical provider: `main-src/src/dqagie.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dqagie.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dqagie.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dqagie.f) — `verified_cached`
...
- Exact Netlib source: [DQAGIE](https://www.netlib.org/slatec/src/dqagie.f)
...
| 2 | `BOUND` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Scalar argument classified by fixed-form executable read/write analysis. |
...
- Canonical Rust path: `slatec_sys::quadrature::callbacks::dqagie`
