...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `CSN` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | Input value at which the source-defined function is evaluated: Compute the complex arc tangent in the proper quadrant |
| 2 | `CCS` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | Input value at which the source-defined function is evaluated: Compute the complex arc tangent in the proper quadrant |
