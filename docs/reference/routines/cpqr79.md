...
- Exact Netlib source: [CPQR79](https://www.netlib.org/slatec/src/cpqr79.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `NDEG` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | ROOT(NDEG), WORK(2*NDEG*(NDEG+1)) degree of polynomial |
| 2 | `COEFF` | `input` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 1; dimensions (*) | ROOT(NDEG), WORK(2*NDEG*(NDEG+1)) COMPLEX coefficients in descending order.  i.e., P(Z)= COEFF(1)*(Z**NDEG) + COEFF(NDEG)*Z + COEFF(NDEG+1) 0.0 3  NDEG is invalid (less than or equal to 0) |
...
| 5 | `WORK` | `workspace` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL work array of dimension at least 2*NDEG*(NDEG+1) |
...
Canonical Rust path: `slatec_sys::roots::complex::cpqr79`. Native symbol: `cpqr79_`. Declaration feature: `nonlinear-complex`. Provider feature: `nonlinear-complex`. ABI fingerprint: `subroutine:void(mut_i32,mut_complex32_array_rank1,mut_complex32_array_rank1,mut_i32,mut_f32_array_rank1)`.
...
- Canonical Rust path: `slatec_sys::roots::complex::cpqr79`
