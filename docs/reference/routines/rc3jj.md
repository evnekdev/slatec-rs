...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `L2` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `L3` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `M2` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `M3` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `L1MIN` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `L1MAX` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `THRCOF` | unavailable | `REAL` (`explicit`) | `*mut f32` | rank 1; dimensions (NDIM) | *Usage: REAL L2, L3, M2, M3, L1MIN, L1MAX, THRCOF(NDIM) INTEGER NDIM, IER CALL RC3JJ (L2, L3, M2, M3, L1MIN, L1MAX, THRCOF, NDIM, IER) *Arguments: L2 :IN Parameter in 3j symbol. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
- Compatibility aliases: `slatec_sys::special::numerical::rc3jj`
