...
- Canonical provider: `main-src/src/dxqmu.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dxqmu.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dxqmu.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dxqmu.f) — `verified_cached`
