...
| 3 | `X` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Double Precision X(N). Solution to L*D*L' x = b. |
...
| 8 | `DINV` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Double Precision DINV(N). Inverse of the diagonal matrix D. |
