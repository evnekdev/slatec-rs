...
- Exact Netlib source: [DLLTI2](https://www.netlib.org/slatec/lin/dllti2.f)
...
| 3 | `X` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | B, where L is a unit lower triangular matrix and D is a diagonal matrix and ' means transpose. OUT      Double Precision X(N). b. |
...
| 8 | `DINV` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | IN       Double Precision DINV(N). Inverse of the diagonal matrix D. |
