...
- Exact Netlib source: [SPOFA](https://www.netlib.org/slatec/lin/spofa.f)
...
Canonical Rust path: `slatec_sys::linear_algebra::dense::spofa`. Native symbol: `spofa_`. Declaration feature: `linear-algebra`. Provider feature: `linear-algebra-real`. ABI fingerprint: `subroutine:void(mut_f32_ptr_rank2,mut_i32,mut_i32,mut_i32)`.
