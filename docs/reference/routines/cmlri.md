...
CMLRI COMPUTES THE I BESSEL FUNCTION FOR RE(Z).GE.0.0 BY THE MILLER ALGORITHM NORMALIZED BY A NEUMANN SERIES.
...
- Canonical provider: `main-src/src/cmlri.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/cmlri.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/cmlri.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/cmlri.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Z` | unavailable | `COMPLEX` (`explicit`) | `*mut crate::Complex32` | scalar | CMLRI COMPUTES THE I BESSEL FUNCTION FOR RE(Z).GE.0.0 BY THE MILLER ALGORITHM NORMALIZED BY A NEUMANN SERIES. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
