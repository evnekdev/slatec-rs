...
| 2 | `X` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | X(N). The vector that should be multiplied by the matrix. |
| 3 | `Y` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | A*X. Y(N). The product of the matrix and the vector. |
