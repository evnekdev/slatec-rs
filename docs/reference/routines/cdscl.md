...
Subroutine CDSCL rescales the YH array whenever the step size is changed.
...
- Canonical provider: `main-src/src/cdscl.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/cdscl.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/cdscl.f) — `verified_cached`
