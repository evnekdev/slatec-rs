...
| 2 | `SX` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | single precision vector with N elements rotated vector SX (unchanged if N. LE. 0). |
...
| 7 | `SS` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | element of rotation matrix. |
