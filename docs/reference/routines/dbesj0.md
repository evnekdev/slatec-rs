...
DBESJ0(X) calculates the double precision Bessel function of the first kind of order zero for double precision argument X. Series for BJ0 on the interval 0. to 1.60000E+01
...
- Exact Netlib source: [DBESJ0](https://www.netlib.org/slatec/fnlib/dbesj0.f)
...
significant figures required  31.21 decimal places required  32.00
...
Canonical Rust path: `slatec_sys::special::bessel::dbesj0`. Native symbol: `dbesj0_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f64(mut_f64)`.
