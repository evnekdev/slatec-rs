...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | calculates the double precision Bessel function of the first kind of order zero for double precision argument X. Series for BJ0        on the interval  0.          to  1.60000E+01 with weighted error   4.39E-32 log weighted error  31.36 significant figures required  31.21 decimal places required  32.00 |
