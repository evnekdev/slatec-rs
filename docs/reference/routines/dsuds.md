...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `A` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 2; dimensions (NRDA, *) | DSUDS solves the underdetermined system of linear equations A Z = B where A is NEQ by NUK and NEQ .LE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `B` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | DSUDS solves the underdetermined system of linear equations A Z = B where A is NEQ by NUK and NEQ .LE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `NEQ` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | DSUDS solves the underdetermined system of linear equations A Z = B where A is NEQ by NUK and NEQ .LE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `NUK` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | DSUDS solves the underdetermined system of linear equations A Z = B where A is NEQ by NUK and NEQ .LE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
