...
| 16 | `RWORK` | `workspace` | `workspace` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (LENW) | WORK     Double Precision RWORK(LENW). Double Precision array used for workspace. 5*N. Upon return the following locations of IWORK hold information which may be of use to the user: |
| 17 | `LENW` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer. 5*N. |
...
`RWORK`: WORK     Double Precision RWORK(LENW). Double Precision array used for workspace. 5*N. Upon return the following locations of IWORK hold information which may be of use to the user:
