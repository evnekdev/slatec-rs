...
| `RTOL` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | THIS SUBROUTINE SETS THE ERROR WEIGHT VECTOR WT ACCORDING TO WT(I)=RTOL(I)*ABS(Y(I))+ATOL(I), I=1,-,N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `ATOL` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | THIS SUBROUTINE SETS THE ERROR WEIGHT VECTOR WT ACCORDING TO WT(I)=RTOL(I)*ABS(Y(I))+ATOL(I), I=1,-,N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `Y` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | THIS SUBROUTINE SETS THE ERROR WEIGHT VECTOR WT ACCORDING TO WT(I)=RTOL(I)*ABS(Y(I))+ATOL(I), I=1,-,N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `WT` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | THIS SUBROUTINE SETS THE ERROR WEIGHT VECTOR WT ACCORDING TO WT(I)=RTOL(I)*ABS(Y(I))+ATOL(I), I=1,-,N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
