...
Alphabetise a character array and re-order one dependent character array.

## Description

This subroutine alphabetises a character array. It then accordingly reorders up to one dependent character array.
