...
- Canonical provider: `main-src/src/sossol.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/sossol.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/sossol.f) — `verified_cached`
