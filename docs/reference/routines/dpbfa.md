...
- Exact Netlib source: [DPBFA](https://www.netlib.org/slatec/lin/dpbfa.f)
...
Canonical Rust path: `slatec_sys::linear_algebra::banded::dpbfa`. Native symbol: `dpbfa_`. Declaration feature: `linear-algebra`. Provider feature: `linear-algebra-real`. ABI fingerprint: `subroutine:void(mut_f64_ptr_rank2,mut_i32,mut_i32,mut_i32,mut_i32)`.
