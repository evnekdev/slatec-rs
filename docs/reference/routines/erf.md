...
- Exact Netlib source: [ERF](https://www.netlib.org/slatec/fnlib/erf.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | calculates the single precision error function for single precision argument X. Series for ERF        on the interval  0.          to  1.00000D+00 with weighted error   7.10E-18 log weighted error  17.15 significant figures required  16.31 decimal places required  17.71 |
...
Canonical Rust path: `slatec_sys::special::error::erf`. Native symbol: `erf_`. Declaration feature: `special-error`. Provider feature: `special-error`. ABI fingerprint: `unavailable`.
