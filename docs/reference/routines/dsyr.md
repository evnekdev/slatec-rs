...
| 6 | `A` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 2; dimensions (LDA, *) | = alpha*x*x' + A, where alpha is a real scalar, x is an n element vector and A is an DOUBLE PRECISION array of DIMENSION ( LDA, n ). |
