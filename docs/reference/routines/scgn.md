...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `N` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer Order of the Matrix. hand side vector and Z is the solution upon return.  NELT, IA, JA, A and is the number of columns in the matrix and |
...
| 21 | `P` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real P(N). |
| 22 | `ATP` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real ATP(N). |
| 23 | `ATZ` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real ATZ(N). |
| 24 | `DZ` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real DZ(N). |
| 25 | `ATDZ` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real ATDZ(N). Real arrays used for workspace. |
