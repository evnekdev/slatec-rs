...
- Exact Netlib source: [GAMMA](https://www.netlib.org/slatec/fnlib/gamma.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Input value at which the source-defined function is evaluated: Compute the complete Gamma function |
...
Canonical Rust path: `slatec_sys::special::gamma::gamma`. Native symbol: `gamma_`. Declaration feature: `special-gamma`. Provider feature: `special-gamma`. ABI fingerprint: `unavailable`.
