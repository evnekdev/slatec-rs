...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `R` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDR, *) | REAL(LDR,P), where LDR. GE. P. contains the upper triangular matrix that is to be downdated. The part of R below the diagonal is not referenced. |
...
| 4 | `X` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(P). contains the row vector that is to be removed from R. X is not altered by SCHDD. |
| 5 | `Z` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDZ, *) | REAL(LDZ,NZ), where LDZ. GE. P. is an array of NZ P-vectors which are to be downdated along with R. contain the downdated quantities. |
...
| 8 | `Y` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(NZ). contains the scalars for the downdating of the vectors Z. Y is not altered by SCHDD. |
