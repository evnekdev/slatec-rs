...
- Exact Netlib source: [QNG](https://www.netlib.org/slatec/src/qng.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `F` | `callback` | `callback` | `REAL` | `reviewed unsafe extern callback function pointer` | scalar | version Function subprogram defining the integrand function F(X). The actual name for F needs to be declared E X T E R N A L in the driver program. |
| 2 | `A` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | version Lower limit of integration. |
| 3 | `B` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | version Upper limit of integration. |
...
Canonical Rust path: `slatec_sys::quadrature::qng`. Native symbol: `qng_`. Declaration feature: `quadrature-nonadaptive`. Provider feature: `quadrature-nonadaptive`. ABI fingerprint: `unavailable`.
