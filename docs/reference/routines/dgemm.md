...
| 9 | `B` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 2; dimensions (LDB, *) | Array argument classified by fixed-form executable read/write analysis. |
...
| 12 | `C` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 2; dimensions (LDC, *) | Array argument classified by fixed-form executable read/write analysis. |
