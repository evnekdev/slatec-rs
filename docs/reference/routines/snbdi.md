...
- Exact Netlib source: [SNBDI](https://www.netlib.org/slatec/src/snbdi.f)
...
| 6 | `IPVT` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | INTEGER(N) the pivot vector from SNBCO or SNBFA. On Return |
...
Canonical Rust path: `slatec_sys::linear_algebra::banded::snbdi`. Native symbol: `snbdi_`. Declaration feature: `linear-algebra`. Provider feature: `linear-algebra-real`. ABI fingerprint: `subroutine:void(mut_f32_ptr_rank2,mut_i32,mut_i32,mut_i32,mut_i32,mut_i32_ptr_rank1,mut_f32_ptr_rank1)`.
