...
- Canonical provider: `main-src/src/la05as.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/la05as.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/la05as.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/la05as.f) — `verified_cached`
