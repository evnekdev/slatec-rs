...
| 3 | `X` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Double Precision X(N). Solution to Lx = b. |
| 4 | `NEL` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | Integer. Number of non-zeros in the EL array. |
| 5 | `IEL` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (NEL) | IEL(NEL). the unit lower triangular factor of the incomplete decomposition of the A matrix stored in SLAP Row format. The diagonal of ones *IS* stored. This structure can be set up by the DS2LT routine. See the "Description", below, for more details about the SLAP Row. |
| 6 | `JEL` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (NEL) | JEL(NEL). the unit lower triangular factor of the incomplete decomposition of the A matrix stored in SLAP Row format. The diagonal of ones *IS* stored. This structure can be set up by the DS2LT routine. See the "Description", below, for more details about the SLAP Row. |
| 7 | `EL` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (NEL) | Double Precision EL(NEL). the unit lower triangular factor of the incomplete decomposition of the A matrix stored in SLAP Row format. The diagonal of ones *IS* stored. This structure can be set up by the DS2LT routine. See the "Description", below, for more details about the SLAP Row. |
