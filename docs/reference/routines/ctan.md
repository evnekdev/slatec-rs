...
- Exact Netlib source: [CTAN](https://www.netlib.org/slatec/fnlib/ctan.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `Z` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | calculates the complex trigonometric tangent of complex is in units of radians. is in units of radians. |
...
Canonical Rust path: `slatec_sys::special::complex::ctan`. Native symbol: `ctan_`. Declaration feature: `special-complex`. Provider feature: `special-complex`. ABI fingerprint: `function:complex32(mut_complex32)`.
