...
This routine performs a QR factorization of A using Householder transformations. Row and column pivots are chosen to reduce the growth of round-off and to help detect possible rank deficiency.
...
- Canonical provider: `main-src/src/u11ls.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/u11ls.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/u11ls.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/u11ls.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `A` | unavailable | `REAL` (`implicit_rule`) | `*mut f32` | rank 2; dimensions (MDA, *) | This routine performs a QR factorization of A using Householder transformations. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
