...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `N` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | number of elements in input vector(s) 1, interchange  SX(LX+I*INCX) and SY(LY+I*INCY), |
| 2 | `SX` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | single precision vector with N elements input vector SY (unchanged if N .LE. 0) |
...
| 4 | `SY` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | single precision vector with N elements input vector SX (unchanged if N .LE. 0) Interchange single precision SX and single precision SY. |
