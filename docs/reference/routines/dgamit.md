...
Canonical Rust path: `slatec_sys::special::gamma::dgamit`. Native symbol: `dgamit_`. Declaration feature: `special-gamma`. Provider feature: `special-gamma`. ABI fingerprint: `unavailable`.
