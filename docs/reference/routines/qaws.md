...
| 4 | `ALFA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Parameter in the integrand function, ALFA. GT. (-1) If ALFA. LE. (-1), the routine will end with IER = 6. |
| 5 | `BETA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Parameter in the integrand function, BETA. GT. (-1) If BETA. LE. (-1), the routine will end with IER = 6. |
...
| 17 | `WORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension LENW. |
