...
- Exact Netlib source: [DSINDG](https://www.netlib.org/slatec/fnlib/dsindg.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | calculates the double precision sine for double is in degrees. is in degrees. |
...
Canonical Rust path: `slatec_sys::special::elementary::dsindg`. Native symbol: `dsindg_`. Declaration feature: `special-elementary`. Provider feature: `special-elementary`. ABI fingerprint: `unavailable`.
