...
BESI0(X) computes the modified (hyperbolic) Bessel function of the first kind of order zero and real argument X. Series for BI0 on the interval 0. to 9.00000D+00
...
- Exact Netlib source: [BESI0](https://www.netlib.org/slatec/fnlib/besi0.f)
...
significant figures required  17.90 decimal places required  18.15
...
Canonical Rust path: `slatec_sys::special::bessel::besi0`. Native symbol: `besi0_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f32(mut_f32)`.
