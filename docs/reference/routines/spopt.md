...
- Canonical provider: `main-src/src/spopt.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/spopt.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/spopt.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/spopt.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `PRGOPT` | unavailable | `REAL` (`explicit`) | `*mut f32` | rank 1; dimensions (*) | /REAL (12 BLANKS)/DOUBLE PRECISION/, /R1MACH/D1MACH/,/E0/D0/ REVISED 821122-1045 REVISED YYMMDD-HHMM THIS SUBROUTINE PROCESSES THE OPTION VECTOR, PRGOPT(*), AND VALIDATES ANY MODIFIED DATA. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `ROPT` | unavailable | `REAL` (`explicit`) | `*mut f32` | rank 1; dimensions (07) | No separable argument description was found in the selected source prologue. | unavailable Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
