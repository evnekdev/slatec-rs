...
- Canonical provider: `main-src/src/zseri.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zseri.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zseri.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zseri.f) — `verified_cached`
