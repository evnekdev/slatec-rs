...
- Canonical provider: `main-src/src/chkpr4.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/chkpr4.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/chkpr4.f) — `verified_cached`
