...
- Canonical provider: `main-src/src/pnnzrs.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/pnnzrs.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/pnnzrs.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/pnnzrs.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `I` | output | `INTEGER` (`implicit_rule`) | `*mut crate::FortranInteger` | scalar | SUBROUTINE PNNZRS() GETS THE NEXT NONZERO VALUE IN ROW OR COLUMN +/- IRCX WITH AN INDEX GREATER THAN THE VALUE OF I. | SUBROUTINE PNNZRS() GETS THE NEXT NONZERO VALUE IN ROW OR COLUMN +/- IRCX WITH AN INDEX GREATER THAN THE VALUE OF I. Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `XVAL` | output | `REAL` (`explicit`) | `*mut f32` | scalar | XVAL VALUE OF THE NONZERO ELEMENT FOUND. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `IPLACE` | output | `INTEGER` (`implicit_rule`) | `*mut crate::FortranInteger` | scalar | IPLACE POINTER INFORMATION WHICH IS MAINTAINED BY THE PACKAGE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
