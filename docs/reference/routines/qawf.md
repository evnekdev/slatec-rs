...
| 3 | `OMEGA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Parameter in the integrand WEIGHT function. |
...
| 5 | `EPSABS` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Absolute accuracy requested, EPSABS. GT. 0. If EPSABS. LE. 0, the routine will end with IER = 6. |
...
| 16 | `WORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension at least. |
