...
- Parent-family evidence: `ZAIRY, ZBESH, ZBESI, ZBESK`
...
- Canonical provider: `main-src/src/zbknu.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zbknu.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zbknu.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zbknu.f) — `verified_cached`
