...
- Canonical provider: `main-src/src/du12us.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/du12us.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/du12us.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/du12us.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `A` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 2; dimensions (MDA, *) | Given the Householder LQ factorization of A, this subroutine solves the system AX=B. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `B` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 2; dimensions (MDB, *) | Given the Householder LQ factorization of A, this subroutine solves the system AX=B. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `RNORM` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 1; dimensions (*) | No separable argument description was found in the selected source prologue. | unavailable Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `W` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 1; dimensions (*) | Note - If MODE.NE.2, W is never accessed. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
