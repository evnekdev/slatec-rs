...
- Canonical provider: `main-src/src/fundoc.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/fundoc.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/fundoc.f) — `verified_cached`
