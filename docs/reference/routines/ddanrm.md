...
| `V` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (NEQ) | THIS FUNCTION ROUTINE COMPUTES THE WEIGHTED ROOT-MEAN-SQUARE NORM OF THE VECTOR OF LENGTH NEQ CONTAINED IN THE ARRAY V,WITH WEIGHTS CONTAINED IN THE ARRAY WT OF LENGTH NEQ. | THIS FUNCTION ROUTINE COMPUTES THE WEIGHTED ROOT-MEAN-SQUARE NORM OF THE VECTOR OF LENGTH NEQ CONTAINED IN THE ARRAY V,WITH WEIGHTS CONTAINED IN THE ARRAY WT OF LENGTH NEQ. Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `WT` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (NEQ) | THIS FUNCTION ROUTINE COMPUTES THE WEIGHTED ROOT-MEAN-SQUARE NORM OF THE VECTOR OF LENGTH NEQ CONTAINED IN THE ARRAY V,WITH WEIGHTS CONTAINED IN THE ARRAY WT OF LENGTH NEQ. | THIS FUNCTION ROUTINE COMPUTES THE WEIGHTED ROOT-MEAN-SQUARE NORM OF THE VECTOR OF LENGTH NEQ CONTAINED IN THE ARRAY V,WITH WEIGHTS CONTAINED IN THE ARRAY WT OF LENGTH NEQ. Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
