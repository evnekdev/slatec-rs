...
- Canonical provider: `main-src/src/la05bd.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/la05bd.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/la05bd.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/la05bd.f) — `verified_cached`
