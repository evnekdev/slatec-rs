...
- Exact Netlib source: [SSDCG](https://www.netlib.org/slatec/lin/ssdcg.f)
...
| 16 | `RWORK` | `workspace` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (LENW) | WORK     Real RWORK(LENW). Real array used for workspace. 5*N. |
