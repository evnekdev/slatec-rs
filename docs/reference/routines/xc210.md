...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `K` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | INTEGER K, J REAL Z GIVEN K THIS SUBROUTINE COMPUTES J AND Z SUCH THAT RADIX**K = Z*10**J, WHERE Z IS IN THE RANGE 1/10 .LE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `Z` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | INTEGER K, J REAL Z GIVEN K THIS SUBROUTINE COMPUTES J AND Z SUCH THAT RADIX**K = Z*10**J, WHERE Z IS IN THE RANGE 1/10 .LE. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
