...
| 3 | `B` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Upper limit of integration, B. GT. A If B. LE. A, the routine will end with IER = 6. |
| 4 | `ALFA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Parameter in the WEIGHT function, ALFA. GT. (-1) If ALFA. LE. (-1), the routine will end with IER = 6. |
| 5 | `BETA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Parameter in the WEIGHT function, BETA. GT. (-1) If BETA. LE. (-1), the routine will end with IER = 6. |
...
| 7 | `EPSABS` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Absolute accuracy requested. |
| 8 | `EPSREL` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Relative accuracy requested If EPSABS. LE. 0 and EPSREL. LT. MAX(50*REL. MACH. |
...
| 10 | `RESULT` | `output` | `scalar` | `REAL` | `*mut f32` | scalar | Approximation to the integral. |
...
| 14 | `ALIST` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension at least LIMIT, the first. |
| 15 | `BLIST` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension at least LIMIT, the first. |
| 16 | `RLIST` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension at least LIMIT, the first. |
| 17 | `ELIST` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension at least LIMIT, the first. |
