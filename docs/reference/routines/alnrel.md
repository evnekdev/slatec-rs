...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Input value at which the source-defined function is evaluated: Evaluate ln(1+X) accurate in the sense of relative error |
...
Canonical Rust path: `slatec_sys::special::elementary::alnrel`. Native symbol: `alnrel_`. Declaration feature: `special-elementary`. Provider feature: `special-elementary`. ABI fingerprint: `unavailable`.
