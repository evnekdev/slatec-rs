...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `DX` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | DPSORT returns the permutation vector IPERM generated by sorting the array DX and, optionally, rearranges the values in DX. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `IPERM` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | rank 1; dimensions (*) | DPSORT returns the permutation vector IPERM generated by sorting the array DX and, optionally, rearranges the values in DX. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
