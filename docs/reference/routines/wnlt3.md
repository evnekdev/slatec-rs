...
- Canonical provider: `main-src/src/wnlt3.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/wnlt3.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/wnlt3.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/wnlt3.f) — `verified_cached`
