...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ABE` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDA, *) | Array argument classified by fixed-form executable read/write analysis. |
...
| 6 | `V` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
...
| 9 | `WORK` | `workspace` | `workspace` | `REAL` | `*mut f32` | rank 2; dimensions (N, *) | Workspace argument classified by fixed-form executable read/write analysis. |
