...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ALFA` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Double precision 1) 1,X), K = 1, ..., 25. 1,X), K = 1, ..., 25. |
| 2 | `BETA` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Double precision 1) K = 1, ..., 25. K = 1, ..., 25. |
| 3 | `RI` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (25) | Double precision Vector of dimension 25 1,1) of |
| 4 | `RJ` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (25) | Double precision Vector of dimension 25 1,1) of |
| 5 | `RG` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (25) | Double precision Vector of dimension 25 1,1) of |
| 6 | `RH` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (25) | Double precision Vector of dimension 25 1,1) of |
