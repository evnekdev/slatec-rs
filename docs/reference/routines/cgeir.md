...
| 7 | `WORK` | `workspace` | `workspace` | `COMPLEX` | `*mut crate::Complex32` | rank 2; dimensions (N, *) | must not have been altered by the COMPLEX(N*(N+1)) |
