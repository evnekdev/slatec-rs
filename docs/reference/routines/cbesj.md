...
- Canonical provider: `main-src/src/cbesj.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/cbesj.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/cbesj.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/cbesj.f) — `verified_cached`
...
Canonical Rust path: `slatec_sys::special::complex::cbesj`. Native symbol: `cbesj_`. Declaration feature: `special-complex`. Provider feature: `special-complex`. ABI fingerprint: `subroutine:void(mut_complex32,mut_f32,mut_i32,mut_i32,mut_complex32_array_rank1,mut_i32,mut_i32)`.
