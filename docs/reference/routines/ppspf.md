...
- Canonical provider: `main-src/src/ppspf.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/ppspf.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/ppspf.f) — `verified_cached`
