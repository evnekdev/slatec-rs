...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `Z` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | calculates the complex trigonometric arc tangent of Z. The result is in units of radians, and the real part is in the first or fourth quadrant. |
