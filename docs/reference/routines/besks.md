...
Canonical Rust path: `slatec_sys::special::bessel::besks`. Native symbol: `besks_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `subroutine:void(mut_f32,mut_f32,mut_i32,mut_f32_ptr_rank1)`.
