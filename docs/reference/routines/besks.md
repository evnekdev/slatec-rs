...
- Canonical provider: `fnlib/besks.f` (`relocated-subset`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/fnlib/besks.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/fnlib/besks.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `XNU` | output | `REAL` (`implicit_rule`) | `*mut f32` | scalar | BESKS computes a sequence of modified Bessel functions of the third kind of order XNU + I at X, where X .GT. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `X` | output | `REAL` (`implicit_rule`) | `*mut f32` | scalar | BESKS computes a sequence of modified Bessel functions of the third kind of order XNU + I at X, where X .GT. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
- Compatibility aliases: `slatec_sys::special::numerical::besks`
