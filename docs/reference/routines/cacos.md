...
- Exact Netlib source: [CACOS](https://www.netlib.org/slatec/fnlib/cacos.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `Z` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | calculates the complex trigonometric arc cosine of Z. The result is in units of radians, and the real part is in the first or second quadrant. |
...
Canonical Rust path: `slatec_sys::special::complex::cacos`. Native symbol: `cacos_`. Declaration feature: `special-complex`. Provider feature: `special-complex`. ABI fingerprint: `function:complex32(mut_complex32)`.
