...
- Exact Netlib source: [COSDG](https://www.netlib.org/slatec/fnlib/cosdg.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Input value at which the source-defined function is evaluated: Compute the cosine of an argument in degrees |
...
Canonical Rust path: `slatec_sys::special::elementary::cosdg`. Native symbol: `cosdg_`. Declaration feature: `special-elementary`. Provider feature: `special-elementary`. ABI fingerprint: `unavailable`.
