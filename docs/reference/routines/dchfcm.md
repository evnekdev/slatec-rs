...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `D1` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | *Usage: DOUBLE PRECISION D1, D2, DELTA INTEGER ISMON, DCHFCM ISMON = DCHFCM (D1, D2, DELTA) *Arguments: D1,D2:IN are the derivative values at the ends of an interval. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `D2` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | *Usage: DOUBLE PRECISION D1, D2, DELTA INTEGER ISMON, DCHFCM ISMON = DCHFCM (D1, D2, DELTA) *Arguments: D1,D2:IN are the derivative values at the ends of an interval. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `DELTA` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | *Usage: DOUBLE PRECISION D1, D2, DELTA INTEGER ISMON, DCHFCM ISMON = DCHFCM (D1, D2, DELTA) *Arguments: D1,D2:IN are the derivative values at the ends of an interval. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
