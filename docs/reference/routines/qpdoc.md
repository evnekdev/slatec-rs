...
- Canonical provider: `main-src/src/qpdoc.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/qpdoc.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/qpdoc.f) — `verified_cached`
