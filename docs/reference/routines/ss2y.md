...
Canonical Rust path: `slatec_sys::blas::level1::ss2y`. Native symbol: `ss2y_`. Declaration feature: `blas-level1`. Provider feature: `blas-level1`. ABI fingerprint: `unavailable`.
