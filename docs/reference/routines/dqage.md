...
- Canonical provider: `main-src/src/dqage.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dqage.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dqage.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dqage.f) — `verified_cached`
