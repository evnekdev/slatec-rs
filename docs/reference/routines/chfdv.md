...
| 8 | `XE` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | (input) real array of points at which the functions are to be evaluated. If any of the XE are outside the interval [X1,X2], a warning error is returned in NEXT. |
