...
| 7 | `WORK` | `workspace` | `workspace` | `REAL` | `*mut f32` | rank 2; dimensions (N, *) | Workspace argument classified by fixed-form executable read/write analysis. |
