...
DSVCO transfers data from a common block to arrays within the integrator package DDEBDF.
...
- Canonical provider: `main-src/src/dsvco.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dsvco.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dsvco.f) — `verified_cached`
