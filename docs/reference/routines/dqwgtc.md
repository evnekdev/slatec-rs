...
- Canonical provider: `main-src/src/dqwgtc.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dqwgtc.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dqwgtc.f) — `verified_cached`
