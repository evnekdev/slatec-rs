...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `T` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | knot array of length N+K. LE. X. T(N+1). |
...
| 5 | `X1` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | end points of quadrature interval in. |
| 6 | `X2` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | end points of quadrature interval in. |
| 7 | `BQUAD` | `output` | `scalar` | `REAL` | `*mut f32` | scalar | integral of the B-spline over (X1,X2). |
| 8 | `WORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | work vector of length 3*K. |
