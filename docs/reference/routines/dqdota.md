...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `N` | `output` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | 1 of DX(LX+I*INCX) * DY(LY+I*INCY),  where QC is an extended precision result previously computed by DQDOTI or DQDOTA |
| 2 | `DB` | `output` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | 1 of DX(LX+I*INCX) * DY(LY+I*INCY),  where QC is an extended precision result previously computed by DQDOTI or DQDOTA |
| 3 | `QC` | `output` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (30) | 1 of 1 of DX(LX+I*INCX) * DY(LY+I*INCY),  where QC is an extended DX(LX+I*INCX) * DY(LY+I*INCY),  where QC is an extended precision result previously computed by DQDOTI or DQDOTA precision result previously computed by DQDOTI or DQDOTA |
