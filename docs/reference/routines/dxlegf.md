...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `DNU1` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Scalar argument classified by fixed-form executable read/write analysis. |
...
| 5 | `THETA` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Scalar argument classified by fixed-form executable read/write analysis. |
...
| 7 | `PQA` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
...
DXSET (probably due to a software malfunction in the library routine I1MACH). was detected in DXADJ. was detected in DXC210.
