...
- Exact Netlib source: [QAGS](https://www.netlib.org/slatec/src/qags.f)
...
| 2 | `A` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Real Lower limit of integration LIMIT.GE.1. |
...
Canonical Rust path: `slatec_sys::quadrature::qags`. Native symbol: `qags_`. Declaration feature: `quadrature-basic`. Provider feature: `quadrature-basic`. ABI fingerprint: `unavailable`.
...
- Canonical Rust path: `slatec_sys::quadrature::qags`
