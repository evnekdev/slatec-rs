...
- Exact Netlib source: [DATANH](https://www.netlib.org/slatec/fnlib/datanh.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | calculates the double precision arc hyperbolic tangent for double precision argument X. Series for ATNH       on the interval  0.          to  2.50000E-01 with weighted error   6.86E-32 log weighted error  31.16 significant figures required  30.00 decimal places required  31.88 |
...
Canonical Rust path: `slatec_sys::special::datanh`. Native symbol: `datanh_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f64(mut_f64)`.
