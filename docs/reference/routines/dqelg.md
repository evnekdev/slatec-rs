...
| `EPSTAB` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (52) | Epsilon algorithm Standard fortran subroutine Double precision version PARAMETERS N - Integer EPSTAB(N) contains the new element in the first column of the epsilon table. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `RESULT` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | RESULT - Double precision Resulting approximation to the integral ABSERR - Double precision Estimate of the absolute error computed from RESULT and the 3 previous results RES3LA - Double precision Vector of dimension 3 containing the last 3 results NRES - Integer Number of calls to the routine (should be zero at first call) | RESULT - Double precision Resulting approximation to the integral ABSERR - Double precision Estimate of the absolute error computed from RESULT and the 3 previous results RES3LA - Double precision Vector of dimension 3 containing the last 3 results NRES - Integer Number of calls to the routine (should be zero at first call) Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `ABSERR` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | RESULT - Double precision Resulting approximation to the integral ABSERR - Double precision Estimate of the absolute error computed from RESULT and the 3 previous results RES3LA - Double precision Vector of dimension 3 containing the last 3 results NRES - Integer Number of calls to the routine (should be zero at first call) | RESULT - Double precision Resulting approximation to the integral ABSERR - Double precision Estimate of the absolute error computed from RESULT and the 3 previous results RES3LA - Double precision Vector of dimension 3 containing the last 3 results NRES - Integer Number of calls to the routine (should be zero at first call) Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `RES3LA` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (3) | RESULT - Double precision Resulting approximation to the integral ABSERR - Double precision Estimate of the absolute error computed from RESULT and the 3 previous results RES3LA - Double precision Vector of dimension 3 containing the last 3 results NRES - Integer Number of calls to the routine (should be zero at first call) | RESULT - Double precision Resulting approximation to the integral ABSERR - Double precision Estimate of the absolute error computed from RESULT and the 3 previous results RES3LA - Double precision Vector of dimension 3 containing the last 3 results NRES - Integer Number of calls to the routine (should be zero at first call) Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
