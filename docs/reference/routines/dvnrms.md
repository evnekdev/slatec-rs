...
DVNRMS computes a weighted root-mean-square vector norm for the integrator package DDEBDF.
...
- Canonical provider: `main-src/src/dvnrms.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dvnrms.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dvnrms.f) — `verified_cached`
