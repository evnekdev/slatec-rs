...
- Canonical provider: `main-src/src/splpfe.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/splpfe.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/splpfe.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/splpfe.f) — `verified_cached`
