...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | value at which the series is to be evaluated. |
| 2 | `CS` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | array of N terms of a Chebyshev series. In evaluating CS, only half the first coefficient is summed. |
