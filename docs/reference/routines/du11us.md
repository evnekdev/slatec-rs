...
This routine performs an LQ factorization of the matrix A using Householder transformations. Row and column pivots are chosen to reduce the growth of round-off and to help detect possible rank deficiency.
...
- Canonical provider: `main-src/src/du11us.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/du11us.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/du11us.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/du11us.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `A` | unavailable | `DOUBLE PRECISION` (`implicit_rule`) | `*mut f64` | rank 2; dimensions (MDA, *) | This routine performs an LQ factorization of the matrix A using Householder transformations. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
