...
- Exact Netlib source: [DSPENC](https://www.netlib.org/slatec/fnlib/dspenc.f)
...
Canonical Rust path: `slatec_sys::special::dspenc`. Native symbol: `dspenc_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f64(mut_f64)`.
