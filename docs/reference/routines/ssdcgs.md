...
| 7 | `A` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | B. |
...
| 10 | `TOL` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | inv time a vector is the pre- conditioning step.  This is the *NATURAL* stopping for this iterative method and is *STRONGLY* recommended. |
