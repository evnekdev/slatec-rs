...
| 3 | `B` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (NM, *) | contains information about the similarity transformation (Cholesky decomposition) used in the reduction by  REDUC2 dimensional REAL array, dimensioned B(NM,N). system Routines - EISPACK Guide, Springer-Verlag, 1976. |
