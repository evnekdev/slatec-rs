...
| 3 | `X` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | A'y. X(N). On input X is your initial guess for solution vector. On output X is the final approximate solution. |
