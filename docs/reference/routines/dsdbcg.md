...
| 17 | `LENW` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer. Length of the double precision workspace, RWORK. 8*N. |
...
| 19 | `LENIW` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer. 10. Upon return the following locations of IWORK hold information which may be of use to the user: |
...
`IWORK`: WORK     Integer IWORK(LENIW). Used to hold pointers into the RWORK array. 10. Upon return the following locations of IWORK hold information which may be of use to the user: Amount of Integer workspace actually used. Amount of Double Precision workspace actually used.
