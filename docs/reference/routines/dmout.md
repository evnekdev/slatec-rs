...
- Parent-family evidence: `DBOCLS, DFC`
...
- Canonical provider: `main-src/src/dmout.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dmout.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dmout.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dmout.f) — `verified_cached`
