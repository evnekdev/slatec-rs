...
| 2 | `Y` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
| 3 | `XOUT` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Scalar argument classified by fixed-form executable read/write analysis. |
| 4 | `YOUT` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
| 5 | `YPOUT` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
...
| 8 | `PHI` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (NEQN, 16) | Array argument classified by fixed-form executable read/write analysis. |
...
| 12 | `GI` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (11) | Array argument classified by fixed-form executable read/write analysis. |
| 13 | `ALPHA` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (12) | Array argument classified by fixed-form executable read/write analysis. |
| 14 | `OG` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (13) | Array argument classified by fixed-form executable read/write analysis. |
| 15 | `OW` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (12) | Array argument classified by fixed-form executable read/write analysis. |
| 16 | `OX` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Scalar argument classified by fixed-form executable read/write analysis. |
| 17 | `OY` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
