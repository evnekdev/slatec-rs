...
| 5 | `A` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (NELT) | Double Precision A(NELT). These arrays should hold the matrix A in the SLAP Column format. See "Description", below. |
...
| 7 | `DINV` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Double Precision DINV(N). Upon return this array holds 1. /DIAG(A). |
