...
| 21 | `DZ` | `workspace-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Double Precision DZ(N). Double Precision arrays used for workspace. |
| 22 | `RWORK` | `workspace-output` | `workspace` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (*) | Double Precision RWORK(USER DEFINED). Double Precision array that can be used by MSOLVE. |
| 23 | `IWORK` | `workspace-output` | `workspace` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | IWORK(USER DEFINED). array that can be used by MSOLVE. |
