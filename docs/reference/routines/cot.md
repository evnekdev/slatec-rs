...
COT(X) calculates the cotangent of the real argument X. X is in units of radians. Series for COT on the interval 0. to 6.25000D-02
...
significant figures required  15.51 decimal places required  16.88
