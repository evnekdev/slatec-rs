...
ZMLRI COMPUTES THE I BESSEL FUNCTION FOR RE(Z).GE.0.0 BY THE MILLER ALGORITHM NORMALIZED BY A NEUMANN SERIES.
...
- Canonical provider: `main-src/src/zmlri.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zmlri.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zmlri.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zmlri.f) — `verified_cached`
