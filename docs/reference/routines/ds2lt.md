...
| 10 | `EL` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (NELT) | Double Precision EL(NEL). the lower triangle of the A matrix stored in SLAP Column format. See "Description", below, for more details bout the SLAP Column format. |
