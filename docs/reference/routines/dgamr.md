...
- Exact Netlib source: [DGAMR](https://www.netlib.org/slatec/fnlib/dgamr.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Input value at which the source-defined function is evaluated: Compute the reciprocal of the Gamma function |
...
Canonical Rust path: `slatec_sys::special::gamma::dgamr`. Native symbol: `dgamr_`. Declaration feature: `special-gamma`. Provider feature: `special-gamma`. ABI fingerprint: `unavailable`.
