...
Subroutine COSQF1 computes the fast Fourier transform of quarter wave data. That is, COSQF1 computes the coefficients in a cosine series representation with only odd wave numbers. The transform is defined below at Output Parameter X
...
- Canonical provider: `fishfft/cosqf1.f` (`relocated-subset`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/fishfft/cosqf1.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/fishfft/cosqf1.f) — `verified_cached`
