...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `R` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDR, *) | Array argument classified by fixed-form executable read/write analysis. |
...
| 5 | `Z` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDZ, *) | Array argument classified by fixed-form executable read/write analysis. |
...
| 8 | `Y` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
...
| 11 | `S` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
