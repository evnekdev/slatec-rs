...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `R` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDR, *) | REAL(LDR,P), where LDR. GE. P. contains the upper triangular matrix that is to be updated. The part of R below the diagonal is not referenced. |
...
| 4 | `X` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(P). contains the row to be added to R. X is not altered by SCHUD. |
| 5 | `Z` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDZ, *) | REAL(LDZ,NZ), where LDZ. GE. P. is an array containing NZ P-vectors to be updated with R. not altered by SCHUD. |
...
| 8 | `Y` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(NZ). contains the scalars for updating the vectors not altered by SCHUD. |
...
| 11 | `S` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(P). contains the sines of the transforming rotations. |
