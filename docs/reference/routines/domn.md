...
| 11 | `NSAVE` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | Integer. Number of direction vectors to save and orthogonalize against. NSAVE >= 0. |
...
| 21 | `P` | `workspace-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 2; dimensions (N, 0:NSAVE) | Double Precision P(N,0:NSAVE). |
| 22 | `AP` | `workspace-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 2; dimensions (N, 0:NSAVE) | Double Precision AP(N,0:NSAVE). |
| 23 | `EMAP` | `workspace-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 2; dimensions (N, 0:NSAVE) | Double Precision EMAP(N,0:NSAVE). |
| 24 | `DZ` | `workspace-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Double Precision DZ(N). |
| 25 | `CSAV` | `workspace-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (NSAVE) | Double Precision CSAV(NSAVE) Double Precision arrays used for workspace. |
| 26 | `RWORK` | `workspace-output` | `workspace` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (*) | Double Precision RWORK(USER DEFINED). Double Precision array that can be used for workspace in. |
| 27 | `IWORK` | `workspace-output` | `workspace` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | IWORK(USER DEFINED). array that can be used for workspace in MSOLVE. |
