...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `NM` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | dimensional array parameters, HR and HI, as declared in the calling program dimension statement.  NM is an INTEGER variable. |
...
| 5 | `HR` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (NM, *) | contain the real and imaginary parts, respectively, of the complex upper Hessenberg matrix.  Their lower triangles below the subdiagonal contain information about the unitary transformations used in the reduction by  CORTH, dimensional REAL arrays, dimensioned HR(NM,N) and HI(NM,N). |
| 6 | `HI` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (NM, *) | contain the real and imaginary parts, respectively, of the complex upper Hessenberg matrix.  Their lower triangles below the subdiagonal contain information about the unitary transformations used in the reduction by  CORTH, dimensional REAL arrays, dimensioned HR(NM,N) and HI(NM,N). |
