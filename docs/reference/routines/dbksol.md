...
- Canonical provider: `main-src/src/dbksol.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dbksol.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dbksol.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dbksol.f) — `verified_cached`
...
| `A` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | ********************************************************************** Solution of an upper triangular linear system by back-substitution The matrix A is assumed to be stored in a linear array proceeding in a row-wise manner. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `X` | input | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | The vector X contains the given constant vector on input and contains the solution on return. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
