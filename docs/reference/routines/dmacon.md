...
- Canonical provider: `main-src/src/dmacon.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dmacon.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dmacon.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dmacon.f) — `verified_cached`
