...
| 9 | `AM` | `input` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 1; dimensions (*) | Complex one-dimensional arrays of length M that specify the coefficients in the linear equations given above. |
| 10 | `BM` | `input` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 1; dimensions (*) | Complex one-dimensional arrays of length M that specify the coefficients in the linear equations given above. |
| 11 | `CM` | `input` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 1; dimensions (*) | Complex one-dimensional arrays of length M that specify the coefficients in the linear equations given above. |
...
| 13 | `Y` | `input-output` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 2; dimensions (IDIMY, *) | A complex two-dimensional array that specifies the values of the right side of the linear system of equations given above. must be dimensioned Y(IDIMY,N) with IDIMY. GE. M. Contains the solution X. |
