...
- Canonical provider: `main-src/src/r1mach.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/r1mach.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/r1mach.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/r1mach.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `I` | output | `INTEGER` (`implicit_rule`) | `*mut crate::FortranInteger` | scalar | It is a function subprogram with one (input) argument, and can be referenced as follows: A = R1MACH(I) where I=1,...,5. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
