...
- Canonical provider: `main-src/src/prvec.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/prvec.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/prvec.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/prvec.f) — `verified_cached`
...
| `U` | unavailable | `REAL` (`implicit_rule`) | `*mut f32` | rank 1; dimensions (*) | This subroutine computes the inner product of a vector U with the imaginary product or mate vector corresponding to V | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `V` | unavailable | `REAL` (`implicit_rule`) | `*mut f32` | rank 1; dimensions (*) | This subroutine computes the inner product of a vector U with the imaginary product or mate vector corresponding to V | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
