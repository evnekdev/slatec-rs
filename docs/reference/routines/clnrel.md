...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `Z` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | Input value at which the source-defined function is evaluated: Evaluate ln(1+X) accurate in the sense of relative error |
