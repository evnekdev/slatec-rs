...
Computation of oscillatory integrals Standard fortran subroutine Real version
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `F` | `callback` | `callback` | `REAL` | `reviewed unsafe extern callback function pointer` | scalar | Function subprogram defining the function The actual name for F needs to be declared E X T E R N A L in the driver program. |
...
| 4 | `OMEGA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Parameter in the integrand weight function. |
...
| 17 | `WORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | Vector of dimension at least LENW. |
