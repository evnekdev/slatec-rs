...
It is assumed that RWORK and IWORK have initialized with the information required for SSLI2:
...
- Exact Netlib source: [SSLI](https://www.netlib.org/slatec/lin/ssli.f)
...
| 10 | `IWORK` | `workspace-output` | `workspace` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (10) | NEL Starting location of IEL in IWORK. Starting location of JEL in IWORK. Starting location of EL in RWORK. See the DESCRIPTION of SSLI2 for details. |
