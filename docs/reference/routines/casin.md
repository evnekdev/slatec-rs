...
- Exact Netlib source: [CASIN](https://www.netlib.org/slatec/fnlib/casin.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ZINP` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | calculates the complex trigonometric arc sine of ZINP. The result is in units of radians, and the real part is in the first or fourth quadrant. |
...
Canonical Rust path: `slatec_sys::special::complex::casin`. Native symbol: `casin_`. Declaration feature: `special-complex`. Provider feature: `special-complex`. ABI fingerprint: `function:complex32(mut_complex32)`.
