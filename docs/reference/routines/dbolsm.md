...
| `X` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | **** Double Precision Version of SBOLSM **** **** All INPUT and OUTPUT real variables are DOUBLE PRECISION **** Solve E*X = F (least squares sense) with bounds on selected X values. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `WW` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | The user must have DIMENSION statements of the form: DIMENSION W(MDW,NCOLS+1), BL(NCOLS), BU(NCOLS), * X(NCOLS+NX), RW(NCOLS), WW(NCOLS), SCL(NCOLS) INTEGER IND(NCOLS), IOPT(1+NI), IBASIS(NCOLS), IBB(NCOLS) (Here NX=number of extra locations required for options 1,...,7; NX=0 for no options; here NI=number of extra locations possibly required for options 1-7; NI=0 for no options; NI=14 if all the options are simultaneously in use.) | The user must have DIMENSION statements of the form: DIMENSION W(MDW,NCOLS+1), BL(NCOLS), BU(NCOLS), * X(NCOLS+NX), RW(NCOLS), WW(NCOLS), SCL(NCOLS) INTEGER IND(NCOLS), IOPT(1+NI), IBASIS(NCOLS), IBB(NCOLS) (Here NX=number of extra locations required for options 1,...,7; NX=0 for no options; here NI=number of extra locations possibly required for options 1-7; NI=0 for no options; NI=14 if all the options are simultaneously in use.) Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `SCL` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | The user must have DIMENSION statements of the form: DIMENSION W(MDW,NCOLS+1), BL(NCOLS), BU(NCOLS), * X(NCOLS+NX), RW(NCOLS), WW(NCOLS), SCL(NCOLS) INTEGER IND(NCOLS), IOPT(1+NI), IBASIS(NCOLS), IBB(NCOLS) (Here NX=number of extra locations required for options 1,...,7; NX=0 for no options; here NI=number of extra locations possibly required for options 1-7; NI=0 for no options; NI=14 if all the options are simultaneously in use.) | The user must have DIMENSION statements of the form: DIMENSION W(MDW,NCOLS+1), BL(NCOLS), BU(NCOLS), * X(NCOLS+NX), RW(NCOLS), WW(NCOLS), SCL(NCOLS) INTEGER IND(NCOLS), IOPT(1+NI), IBASIS(NCOLS), IBB(NCOLS) (Here NX=number of extra locations required for options 1,...,7; NX=0 for no options; here NI=number of extra locations possibly required for options 1-7; NI=0 for no options; NI=14 if all the options are simultaneously in use.) Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
