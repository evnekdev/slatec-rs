...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `ARG1` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | if ARG1 and ARG2 are of opposite sign. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `ARG2` | unavailable | `REAL` (`explicit`) | `*mut f32` | scalar | if ARG1 and ARG2 are of opposite sign. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
