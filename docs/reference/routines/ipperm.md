...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `IX` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | rank 1; dimensions (*) | IPPERM rearranges the data vector IX according to the permutation IPERM: IX(I) <--- IX(IPERM(I)). | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `IPERM` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | rank 1; dimensions (*) | IPPERM rearranges the data vector IX according to the permutation IPERM: IX(I) <--- IX(IPERM(I)). | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
