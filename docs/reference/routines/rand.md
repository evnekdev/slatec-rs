...
Canonical Rust path: `slatec_sys::statistics::rand`. Native symbol: `rand_`. Declaration feature: `statistics`. Provider feature: `statistics-core`. ABI fingerprint: `function:f32(mut_f32)`.
