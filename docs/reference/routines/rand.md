...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `R` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | If R=0. , the next random number of the sequence is generated. If R. LT. 0. , the last generated number will be returned for possible use in a restart procedure. |
