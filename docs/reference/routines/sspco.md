...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `AP` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | A(I,J) 10    CONTINUE 20 CONTINUE |
...
| 5 | `Z` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | RCOND*NORM(A)*NORM(Z) . Packed Storage The following program segment will pack the upper triangle of a symmetric matrix. K = 0 DO 20 J = 1, N DO 10 I = 1, J K = K + 1 |
