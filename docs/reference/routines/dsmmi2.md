...
| 3 | `X` | `input-output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | b. IL     :IN       Integer IL(NL). JL     :IN       Integer JL(NL). L      :IN       Double Precision L(NL). IL, JL, L contain the unit lower  triangular factor of the incomplete decomposition of some matrix stored in SLAP Row format.  The diagonal of ones *IS* stored.  This structure can  be  set  up  by   the  DSILUS   routine.    See   the "Description", below for  more   details   about  the SLAP format.  (NL is the number of non-zeros in the L array.) DINV   :IN       Double Precision DINV(N). Inverse of the diagonal matrix D. IU     :IN       Integer IU(NU). JU     :IN       Integer JU(NU). U      :IN       Double Precision U(NU). IU, JU, U contain the unit upper  triangular factor of the incomplete decomposition  of   some matrix stored in  SLAP Column  format.  The diagonal  of  ones *IS* stored.  This structure can be set up  by the DSILUS routine.  See   the "Description",  below  for  more  details  about  the SLAP format.  (NU is the number of non-zeros in the U array.) |
| 4 | `IL` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
| 5 | `JL` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
| 6 | `L` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (*) | b. b. IL     :IN       Integer IL(NL). IL     :IN       Integer IL(NL). JL     :IN       Integer JL(NL). JL     :IN       Integer JL(NL). L      :IN       Double Precision L(NL). L      :IN       Double Precision L(NL). IL, JL, L contain the unit lower  triangular factor of the IL, JL, L contain the unit lower  triangular factor of the incomplete decomposition of some matrix stored in SLAP Row incomplete decomposition of some matrix stored in SLAP Row format.  The diagonal of ones *IS* stored.  This structure format.  The diagonal of ones *IS* stored.  This structure can  be  set  up  by   the  DSILUS   routine.    See   the can  be  set  up  by   the  DSILUS   routine.    See   the "Description", below for  more   details   about  the SLAP "Description", below for  more   details   about  the SLAP format.  (NL is the number of non-zeros in the L array.) format.  (NL is the number of non-zeros in the L array.) DINV   :IN       Double Precision DINV(N). DINV   :IN       Double Precision DINV(N). Inverse of the diagonal matrix D. Inverse of the diagonal matrix D. IU     :IN       Integer IU(NU). IU     :IN       Integer IU(NU). JU     :IN       Integer JU(NU). JU     :IN       Integer JU(NU). U      :IN       Double Precision U(NU). U      :IN       Double Precision U(NU). IU, JU, U contain the unit upper  triangular factor of the IU, JU, U contain the unit upper  triangular factor of the incomplete decomposition  of   some matrix stored in  SLAP incomplete decomposition  of   some matrix stored in  SLAP Column  format.  The diagonal  of  ones *IS* stored.  This Column  format.  The diagonal  of  ones *IS* stored.  This structure can be set up  by the DSILUS routine.  See   the structure can be set up  by the DSILUS routine.  See   the "Description",  below  for  more  details  about  the SLAP "Description",  below  for  more  details  about  the SLAP format.  (NU is the number of non-zeros in the U array.) format.  (NU is the number of non-zeros in the U array.) |
| 7 | `DINV` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | Array argument classified by fixed-form executable read/write analysis. |
| 8 | `IU` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
| 9 | `JU` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | Array argument classified by fixed-form executable read/write analysis. |
| 10 | `U` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (N) | b. b. IL     :IN       Integer IL(NL). IL     :IN       Integer IL(NL). JL     :IN       Integer JL(NL). JL     :IN       Integer JL(NL). L      :IN       Double Precision L(NL). L      :IN       Double Precision L(NL). IL, JL, L contain the unit lower  triangular factor of the IL, JL, L contain the unit lower  triangular factor of the incomplete decomposition of some matrix stored in SLAP Row incomplete decomposition of some matrix stored in SLAP Row format.  The diagonal of ones *IS* stored.  This structure format.  The diagonal of ones *IS* stored.  This structure can  be  set  up  by   the  DSILUS   routine.    See   the can  be  set  up  by   the  DSILUS   routine.    See   the "Description", below for  more   details   about  the SLAP "Description", below for  more   details   about  the SLAP format.  (NL is the number of non-zeros in the L array.) format.  (NL is the number of non-zeros in the L array.) DINV   :IN       Double Precision DINV(N). DINV   :IN       Double Precision DINV(N). Inverse of the diagonal matrix D. Inverse of the diagonal matrix D. IU     :IN       Integer IU(NU). IU     :IN       Integer IU(NU). JU     :IN       Integer JU(NU). JU     :IN       Integer JU(NU). U      :IN       Double Precision U(NU). U      :IN       Double Precision U(NU). IU, JU, U contain the unit upper  triangular factor of the IU, JU, U contain the unit upper  triangular factor of the incomplete decomposition  of   some matrix stored in  SLAP incomplete decomposition  of   some matrix stored in  SLAP Column  format.  The diagonal  of  ones *IS* stored.  This Column  format.  The diagonal  of  ones *IS* stored.  This structure can be set up  by the DSILUS routine.  See   the structure can be set up  by the DSILUS routine.  See   the "Description",  below  for  more  details  about  the SLAP "Description",  below  for  more  details  about  the SLAP format.  (NU is the number of non-zeros in the U array.) format.  (NU is the number of non-zeros in the U array.) |
