...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | X .GT. 0.0E0 1)/(X), I=1,...,N 1)/(X), I=1,...,N depending on KODE |
| 2 | `FNU` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | order of the initial K function, FNU .GE. 0.0E0 1)/(X), I=1,...,N 1)/(X), I=1,...,N 1)/(X), I=1,...,N  or 1)/(X), I=1,...,N depending on KODE |
...
| 5 | `Y` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | 1)/(X), I=1,...,N 1)/(X), I=1,...,N a vector whose first n components contain values for the sequence 1)/(X), I=1,...,N  or 1)/(X), I=1,...,N depending on KODE 0.0E0, I=1,...,NZ |
