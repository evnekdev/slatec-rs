...
| 4 | `B` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(N). contains the right hand side of the system. contains the solution, if INFO .EQ. 0. contains the solution, if INFO .EQ. 0. Otherwise B is unaltered. Otherwise B is unaltered. |
