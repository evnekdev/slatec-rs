...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `T` | input/output | `REAL` (`explicit`) | `*mut f32` | rank 2; dimensions (LDT, *) | STRSL solves systems of the form T * X = B or TRANS(T) * X = B where T is a triangular matrix of order N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `LDT` | input | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | On Entry T REAL(LDT,N) T contains the matrix of the system. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `N` | input | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | STRSL solves systems of the form T * X = B or TRANS(T) * X = B where T is a triangular matrix of order N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `B` | input/output | `REAL` (`explicit`) | `*mut f32` | rank 1; dimensions (*) | STRSL solves systems of the form T * X = B or TRANS(T) * X = B where T is a triangular matrix of order N. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
