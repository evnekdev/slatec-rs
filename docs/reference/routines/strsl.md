...
- Exact Netlib source: [STRSL](https://www.netlib.org/slatec/lin/strsl.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `T` | `input` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDT, *) | is a triangular matrix. REAL(LDT,N) contains the matrix of the system. The zero elements of the matrix are not referenced, and the corresponding elements of the array can be used to store other information. |
...
| 4 | `B` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(N). contains the right hand side of the system. B contains the solution, if INFO. EQ. 0. Otherwise B is unaltered. |
...
Canonical Rust path: `slatec_sys::linear_algebra::dense::strsl`. Native symbol: `strsl_`. Declaration feature: `linear-algebra`. Provider feature: `linear-algebra-real`. ABI fingerprint: `subroutine:void(mut_f32_ptr_rank2,mut_i32,mut_i32,mut_f32_ptr_rank1,mut_i32,mut_i32)`.
