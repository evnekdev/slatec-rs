...
- Exact Netlib source: [SSDOMN](https://www.netlib.org/slatec/lin/ssdomn.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `N` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer. Order of the Matrix. is the number of columns in the matrix and |
...
| 11 | `TOL` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | inv is the inverse of the diagonal of A. INOUT    Real. |
...
| 17 | `RWORK` | `workspace` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (LENW) | WORK     Real RWORK(LENW). Real array used for workspace. |
| 18 | `LENW` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer. Length of the real workspace, RWORK. 7*N+NSAVE*(3*N+1). |
| 19 | `IWORK` | `workspace` | `workspace` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (LENIW) | WORK     Integer IWORK(LENIW). Used to hold pointers into the RWORK array. 10. |
| 20 | `LENIW` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer. 10. |
