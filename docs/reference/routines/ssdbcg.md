...
| 17 | `LENW` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | Integer. Length of the real workspace, RWORK. LENW >= 8*N. |
| 18 | `IWORK` | `workspace-output` | `workspace` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (LENIW) | IWORK(LENIW). Used to hold pointers into the RWORK array. Amount of Integer workspace actually used. IWORK(10) Amount of Real workspace actually used. |
...
`IWORK`: IWORK(LENIW). Used to hold pointers into the RWORK array. Amount of Integer workspace actually used. IWORK(10) Amount of Real workspace actually used.
