...
- Canonical provider: `lin/ssdbcg.f` (`relocated-subset`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/lin/ssdbcg.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/lin/ssdbcg.f) — `verified_cached`
...
- Exact Netlib source: [SSDBCG](https://www.netlib.org/slatec/lin/ssdbcg.f)
