...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `Z` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | Input value at which the source-defined function is evaluated: Evaluate (Z+0.5)*LOG((Z+1.)/Z) - 1.0 with relative accuracy |
