...
- Parent-family evidence: `ZAIRY, ZBESH, ZBESI, ZBESJ, ZBESK, ZBIRY`
...
- Canonical provider: `main-src/src/zbinu.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zbinu.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zbinu.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zbinu.f) — `verified_cached`
