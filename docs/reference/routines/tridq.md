...
- Canonical provider: `main-src/src/tridq.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/tridq.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/tridq.f) — `verified_cached`
