...
- Canonical provider: `main-src/src/chkprm.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/chkprm.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/chkprm.f) — `verified_cached`
