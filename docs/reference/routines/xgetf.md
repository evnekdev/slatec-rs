...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `KONTRL` | output | `INTEGER` (`implicit_rule`) | `*mut crate::FortranInteger` | scalar | Abstract XGETF returns the current value of the error control flag in KONTRL. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
