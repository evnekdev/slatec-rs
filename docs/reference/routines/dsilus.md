...
| 10 | `L` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (NL) | Double Precision L(NL). the unit lower triangular factor of the incomplete decomposition of some matrix stored in SLAP Row format. The Diagonal of ones *IS* stored. See "DESCRIPTION", below for more details about the SLAP format. |
...
| 15 | `U` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (NU) | Double Precision U(NU). the unit upper triangular factor of the incomplete decomposition of some matrix stored in SLAP Column format. The Diagonal of ones *IS* stored. See "Description", below for more details about the SLAP. |
