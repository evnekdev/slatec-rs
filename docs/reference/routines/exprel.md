...
Canonical Rust path: `slatec_sys::special::elementary::exprel`. Native symbol: `exprel_`. Declaration feature: `special-elementary`. Provider feature: `special-elementary`. ABI fingerprint: `unavailable`.
