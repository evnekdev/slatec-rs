...
BESK0(X) calculates the modified (hyperbolic) Bessel function of the third kind of order zero for real argument X .GT. 0.0. Series for BK0 on the interval 0. to 4.00000D+00
...
- Exact Netlib source: [BESK0](https://www.netlib.org/slatec/fnlib/besk0.f)
...
significant figures required  17.99 decimal places required  18.97
...
Canonical Rust path: `slatec_sys::special::bessel::besk0`. Native symbol: `besk0_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f32(mut_f32)`.
