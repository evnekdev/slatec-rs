...
| 19 | `Z` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | Z(N). |
| 20 | `DZ` | `workspace-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | DZ(N). arrays used for workspace. |
| 21 | `RWORK` | `workspace-output` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | RWORK(USER DEFINED). array that can be used by MSOLVE. |
