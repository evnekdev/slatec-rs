...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | calculates the double precision Bessel function of the second kind of order zero for double precision argument X. Series for BY0        on the interval  0.          to  1.60000E+01 with weighted error   8.14E-32 log weighted error  31.09 significant figures required  30.31 decimal places required  31.73 |
