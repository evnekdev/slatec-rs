...
DBESY0(X) calculates the double precision Bessel function of the second kind of order zero for double precision argument X. Series for BY0 on the interval 0. to 1.60000E+01
...
- Exact Netlib source: [DBESY0](https://www.netlib.org/slatec/fnlib/dbesy0.f)
...
significant figures required  30.31 decimal places required  31.73
...
Canonical Rust path: `slatec_sys::special::bessel::dbesy0`. Native symbol: `dbesy0_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f64(mut_f64)`.
