...
- Canonical provider: `main-src/src/dpintm.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dpintm.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dpintm.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dpintm.f) — `verified_cached`
