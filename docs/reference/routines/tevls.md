...
- Canonical provider: `main-src/src/tevls.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/tevls.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/tevls.f) — `verified_cached`
