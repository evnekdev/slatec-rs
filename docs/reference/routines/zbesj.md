...
- Canonical provider: `main-src/src/zbesj.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zbesj.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zbesj.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zbesj.f) — `verified_cached`
...
- Exact Netlib source: [ZBESJ](https://www.netlib.org/slatec/src/zbesj.f)
...
Canonical Rust path: `slatec_sys::special::bessel::zbesj`. Native symbol: `zbesj_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `subroutine:void(mut_f64,mut_f64,mut_f64,mut_i32,mut_i32,mut_f64_ptr_rank1,mut_f64_ptr_rank1,mut_i32,mut_i32)`.
