...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `Z` | `input` | `scalar` | `COMPLEX` | `*mut crate::Complex32` | scalar | calculates the complex hyperbolic tangent of complex is in units of radians. is in units of radians. |
