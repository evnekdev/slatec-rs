...
- Canonical provider: `main-src/src/spinit.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/spinit.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/spinit.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/spinit.f) — `verified_cached`
