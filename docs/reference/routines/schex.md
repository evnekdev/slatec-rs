...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `R` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDR, *) | REAL(LDR,P), where LDR. GE. P. contains the upper triangular factor that is to be updated. Elements of R below the diagonal are not referenced. contains the updated factor. |
...
| 6 | `Z` | `input-output` | `array` | `REAL` | `*mut f32` | rank 2; dimensions (LDZ, *) | REAL(LDZ,NZ), where LDZ. GE. P. is an array of NZ P-vectors into which the transformation U is multiplied. Z is not referenced if NZ = 0. contains the updated matrix Z. |
...
| 10 | `S` | `output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | REAL(P). contains the sines of the transforming rotations. |
