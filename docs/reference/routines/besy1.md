...
BESY1(X) calculates the Bessel function of the second kind of order one for real argument X. Series for BY1 on the interval 0. to 1.60000D+01
...
- Exact Netlib source: [BESY1](https://www.netlib.org/slatec/fnlib/besy1.f)
...
significant figures required  17.83 decimal places required  18.30 Series for BM1        on the interval  0.          to  6.25000D-02 significant figures required  14.97 decimal places required  16.91 Series for BTH1       on the interval  0.          to  6.25000D-02 significant figures required  15.96 decimal places required  17.08
...
Canonical Rust path: `slatec_sys::special::bessel::besy1`. Native symbol: `besy1_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f32(mut_f32)`.
