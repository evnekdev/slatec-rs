...
- Parent-family evidence: `DNLS1, DNLS1E, DNSQ, DNSQE`
...
- Canonical provider: `main-src/src/dqrfac.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dqrfac.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dqrfac.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dqrfac.f) — `verified_cached`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `M` | input | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | **** Double Precision version of QRFAC **** This subroutine uses Householder transformations with column pivoting (optional) to compute a QR factorization of the M by N matrix A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `N` | input | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | **** Double Precision version of QRFAC **** This subroutine uses Householder transformations with column pivoting (optional) to compute a QR factorization of the M by N matrix A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `A` | input | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 2; dimensions (LDA, *) | **** Double Precision version of QRFAC **** This subroutine uses Householder transformations with column pivoting (optional) to compute a QR factorization of the M by N matrix A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `LDA` | input | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | The subroutine statement is SUBROUTINE DQRFAC(M,N,A,LDA,PIVOT,IPVT,LIPVT,SIGMA,ACNORM,WA) where M is a positive integer input variable set to the number of rows of A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `ACNORM` | input | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | The subroutine statement is SUBROUTINE DQRFAC(M,N,A,LDA,PIVOT,IPVT,LIPVT,SIGMA,ACNORM,WA) where M is a positive integer input variable set to the number of rows of A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
