...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `DNU1` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | is REAL and greater than or equal to -0. 5;. |
...
| 5 | `THETA` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | is REAL and in the half-open interval (0,PI/2];. |
