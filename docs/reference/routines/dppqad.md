...
| 3 | `XI` | `input` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (*) | break point array of length LXI+1 |
...
| 6 | `X1` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | end points of quadrature interval, normally in XI(1) .LE. X .LE. XI(LXI+1) Output     PQUAD is double precision |
| 7 | `X2` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | end points of quadrature interval, normally in XI(1) .LE. X .LE. XI(LXI+1) Output     PQUAD is double precision |
