...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `N` | `input` | `scalar` | `INTEGER` | `*mut crate::FortranInteger` | scalar | IN       Integer Order of the Matrix. hand side vector, and Z is the solution upon return.  NELT,  IA, JA, A hand side vector, and ZZ is the solution upon return.  NELT, IA, JA, A is the number of columns in the matrix and |
...
| 14 | `TOL` | `input-output` | `scalar` | `REAL` | `*mut f32` | scalar | inv is the inverse of the diagonal of A. INOUT    Real. |
...
| 17 | `ERR` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | OUT      Real. |
...
| 20 | `R` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | hand side vector, and Z is the solution upon return.  NELT,  IA, JA, A WORK     Real R(N). |
| 21 | `Z` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real Z(N). |
| 22 | `P` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real P(N). |
| 23 | `RR` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | is supplied via RWORK and IWORK arrays).  The name of the MTSOLV routine must be declared external in the calling program.  The call- hand side vector, and ZZ is the solution upon return.  NELT, IA, JA, A WORK     Real RR(N). |
| 24 | `ZZ` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | RR for is supplied via RWORK and IWORK arrays).  The name of the MTSOLV routine must be declared external in the calling program.  The call- WORK     Real ZZ(N). |
| 25 | `PP` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real PP(N). 155. |
| 26 | `DZ` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | WORK     Real DZ(N). Real arrays used for workspace. |
| 27 | `RWORK` | `workspace` | `workspace` | `REAL` | `*mut f32` | rank 1; dimensions (*) | and IWORK arrays).   The name  of  the MSOLVE routine must be declared  external  in the  calling   program.   The WORK     Real RWORK(USER DEFINED). Real array that can be used for workspace in MSOLVE and MTSOLV. |
