...
SVCO transfers data from a common block to arrays within the integrator package DEBDF.
...
- Canonical provider: `main-src/src/svco.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/svco.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/svco.f) — `verified_cached`
