...
- Exact Netlib source: [DQAGP](https://www.netlib.org/slatec/src/dqagp.f)
...
| 16 | `WORK` | `workspace` | `workspace` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (*) | Workspace argument classified by fixed-form executable read/write analysis. |
...
Canonical Rust path: `slatec_sys::quadrature::dqagp`. Native symbol: `dqagp_`. Declaration feature: `quadrature-breakpoints`. Provider feature: `quadrature-breakpoints`. ABI fingerprint: `unavailable`.
