...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `I` | output | `INTEGER` (`implicit_rule`) | `*mut crate::FortranInteger` | scalar | SUBROUTINE DPNNZR() GETS THE NEXT NONZERO VALUE IN ROW OR COLUMN +/- IRCX WITH AN INDEX GREATER THAN THE VALUE OF I. | SUBROUTINE DPNNZR() GETS THE NEXT NONZERO VALUE IN ROW OR COLUMN +/- IRCX WITH AN INDEX GREATER THAN THE VALUE OF I. Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `XVAL` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | XVAL VALUE OF THE NONZERO ELEMENT FOUND. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
