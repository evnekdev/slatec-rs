...
- Canonical provider: `main-src/src/sdscl.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/sdscl.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/sdscl.f) — `verified_cached`
