...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Input value at which the source-defined function is evaluated: Evaluate the Bairy function (the Airy function of the second kind) |
...
Canonical Rust path: `slatec_sys::special::airy::bi`. Native symbol: `bi_`. Declaration feature: `special-airy`. Provider feature: `special-airy`. ABI fingerprint: `unavailable`.
