...
| 2 | `A` | `input` | `scalar` | `REAL` | `*mut f32` | scalar | Real Lower limit of integration LAST |
...
| 7 | `RESULT` | `input-output` | `scalar` | `REAL` | `*mut f32` | scalar | Real Approximation to the integral ABSERR, NEVAL, LAST, RLIST(1), |
...
| 11 | `ALIST` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | are set to A and B respectively. Real Vector of dimension at least LIMIT, the first |
| 12 | `BLIST` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (*) | are set to A and B respectively. Real Vector of dimension at least LIMIT, the first |
