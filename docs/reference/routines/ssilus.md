...
| 10 | `L` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NL) | Array argument classified by fixed-form executable read/write analysis. |
| 11 | `DINV` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | Array argument classified by fixed-form executable read/write analysis. |
...
| 15 | `U` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NU) | Array argument classified by fixed-form executable read/write analysis. |
