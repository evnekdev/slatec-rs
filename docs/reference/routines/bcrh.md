...
- Canonical provider: `main-src/src/bcrh.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/bcrh.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/bcrh.f) — `verified_cached`
