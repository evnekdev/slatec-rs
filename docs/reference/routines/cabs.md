...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Z` | output | `COMPLEX` (`explicit`) | `*mut crate::Complex32` | scalar | *Usage: REAL A, CABS COMPLEX Z A = CABS(Z) *Arguments: Z :IN This is the argument. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
