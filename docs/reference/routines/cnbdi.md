...
- Exact Netlib source: [CNBDI](https://www.netlib.org/slatec/src/cnbdi.f)
...
| 6 | `IPVT` | `input` | `array` | `INTEGER` | `*mut crate::FortranInteger` | rank 1; dimensions (*) | INTEGER(N) the pivot vector from CNBCO or CNBFA. On Return |
