...
- Exact Netlib source: [DNBDI](https://www.netlib.org/slatec/src/dnbdi.f)
...
| 7 | `DET` | `output` | `array` | `DOUBLE PRECISION` | `*mut f64` | rank 1; dimensions (2) | DOUBLE PRECISION(2) determinant of original matrix. Determinant = DET(1) * 10. 0**DET(2) with 1. 0. LE. ABS(DET(1)). |
...
Canonical Rust path: `slatec_sys::linear_algebra::banded::dnbdi`. Native symbol: `dnbdi_`. Declaration feature: `linear-algebra`. Provider feature: `linear-algebra-real`. ABI fingerprint: `subroutine:void(mut_f64_ptr_rank2,mut_i32,mut_i32,mut_i32,mut_i32,mut_i32_ptr_rank1,mut_f64_ptr_rank1)`.
