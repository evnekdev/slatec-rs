...
- Canonical provider: `main-src/src/sdaini.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/sdaini.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/sdaini.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/sdaini.f) — `verified_cached`
