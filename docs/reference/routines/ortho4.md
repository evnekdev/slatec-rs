...
- Canonical provider: `main-src/src/ortho4.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/ortho4.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/ortho4.f) — `verified_cached`
