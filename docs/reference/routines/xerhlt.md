...
- Canonical provider: `main-src/src/xerhlt.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/xerhlt.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/xerhlt.f) — `verified_cached`
