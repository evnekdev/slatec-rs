...
BESI1E(X) calculates the exponentially scaled modified (hyperbolic) Bessel function of the first kind of order one for real argument X; i.e., EXP(-ABS(X))*I1(X). Series for BI1 on the interval 0. to 9.00000D+00
...
- Exact Netlib source: [BESI1E](https://www.netlib.org/slatec/fnlib/besi1e.f)
...
significant figures required  16.23 decimal places required  17.14 Series for AI1        on the interval  1.25000D-01 to  3.33333D-01 significant figures required  14.53 decimal places required  16.82 Series for AI12       on the interval  0.          to  1.25000D-01 significant figures required  14.69 decimal places required  17.12
...
Canonical Rust path: `slatec_sys::special::bessel::besi1e`. Native symbol: `besi1e_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f32(mut_f32)`.
