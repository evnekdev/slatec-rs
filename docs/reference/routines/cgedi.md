...
| 5 | `DET` | `input-output` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 1; dimensions (2) | Array argument classified by fixed-form executable read/write analysis. |
