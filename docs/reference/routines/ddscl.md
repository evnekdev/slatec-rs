...
- Canonical provider: `main-src/src/ddscl.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/ddscl.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/ddscl.f) — `verified_cached`
