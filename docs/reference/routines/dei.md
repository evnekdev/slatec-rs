...
- Exact Netlib source: [DEI](https://www.netlib.org/slatec/fnlib/dei.f)

### Arguments

| # | Argument | Direction | Role | Fortran type | Rust raw type | Shape | Contract |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `X` | `input` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Input value at which the source-defined function is evaluated: Compute the exponential integral Ei(X) |
...
Canonical Rust path: `slatec_sys::special::dei`. Native symbol: `dei_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f64(mut_f64)`.
