...
| 4 | `RESULT` | `output` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Double precision Approximation to the integral I POINT GAUSS-KRONROD RULE (RESK) obtained by optimal addition of abscissae to the 20-POINT GAUSS RULE (RESG). |
