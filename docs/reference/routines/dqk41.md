...
| 4 | `RESULT` | `output` | `scalar` | `DOUBLE PRECISION` | `*mut f64` | scalar | Approximation to the integral I is computed by applying the 41-POINT GAUSS-KRONROD RULE (RESK) obtained by optimal addition of abscissae to the 20-POINT GAUSS RULE (RESG). |
