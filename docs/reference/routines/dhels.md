...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `A` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 2; dimensions (LDA, *) | This routine is extracted from the LINPACK routine SGESL with changes due to the fact that A is an upper Hessenberg matrix. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `LDA` | output | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | *Usage: INTEGER LDA, N DOUBLE PRECISION A(LDA,N), Q(2*N), B(N+1) CALL DHELS(A, LDA, N, Q, B) *Arguments: A :IN Double Precision A(LDA,N) The output from DHEQR which contains the upper triangular factor R in the QR decomposition of A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `N` | output | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | *Usage: INTEGER LDA, N DOUBLE PRECISION A(LDA,N), Q(2*N), B(N+1) CALL DHELS(A, LDA, N, Q, B) *Arguments: A :IN Double Precision A(LDA,N) The output from DHEQR which contains the upper triangular factor R in the QR decomposition of A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `Q` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | *Usage: INTEGER LDA, N DOUBLE PRECISION A(LDA,N), Q(2*N), B(N+1) CALL DHELS(A, LDA, N, Q, B) *Arguments: A :IN Double Precision A(LDA,N) The output from DHEQR which contains the upper triangular factor R in the QR decomposition of A. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `B` | output | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | rank 1; dimensions (*) | DHELS solves the least squares problem: MIN(B-A*X,B-A*X) using the factors computed by DHEQR. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
