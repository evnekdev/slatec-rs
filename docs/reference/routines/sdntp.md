...
Subroutine SDNTP interpolates the K-th derivative of Y at TOUT, using the data in the YH array. If K has a value greater than NQ, the NQ-th derivative is calculated.
...
- Canonical provider: `main-src/src/sdntp.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/sdntp.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/sdntp.f) — `verified_cached`
