...
- Canonical provider: `main-src/src/psgf.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/psgf.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/psgf.f) — `verified_cached`
