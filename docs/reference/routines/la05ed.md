...
- Canonical provider: `main-src/src/la05ed.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/la05ed.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/la05ed.f) — `verified_cached`
