...
0 .LT. ERR .LT. 1.0D-8. -1  A equals B, or A and B are too nearly equal to allow normal integration.  ANS is set to zero. - Abnormal code K    - the number of function evaluations actually used to do the integration.  A value of K .GT. 1000 indicates a difficult problem; other programs may be more efficient. DQNC79 will gracefully give up if K exceeds 2000.
