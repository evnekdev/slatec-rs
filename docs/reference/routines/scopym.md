...
Canonical Rust path: `slatec_sys::blas::level1::scopym`. Native symbol: `scopym_`. Declaration feature: `blas-level1`. Provider feature: `blas-level1`. ABI fingerprint: `unavailable`.
