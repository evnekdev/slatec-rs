...
- Canonical provider: `main-src/src/zrati.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/zrati.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/zrati.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/zrati.f) — `verified_cached`
