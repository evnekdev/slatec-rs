...
| 5 | `A` | `input` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NELT) | tion goes well.  It is set to the row index corresponding to the last zero pivot found.  See "Description", below. |
...
| 10 | `EL` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (NEL) | Array argument classified by fixed-form executable read/write analysis. |
| 11 | `D` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | 1./DIAG(A). R      :WORK     Real R(N). Temporary real workspace needed for the factorization. IWARN  :OUT      Integer. |
| 12 | `R` | `input-output` | `array` | `REAL` | `*mut f32` | rank 1; dimensions (N) | Array argument classified by fixed-form executable read/write analysis. |
