...
Canonical Rust path: `slatec_sys::quadrature::dqng`. Native symbol: `dqng_`. Declaration feature: `quadrature-nonadaptive`. Provider feature: `quadrature-nonadaptive`. ABI fingerprint: `unavailable`.
