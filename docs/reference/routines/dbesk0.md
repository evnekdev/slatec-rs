...
DBESK0(X) calculates the double precision modified (hyperbolic) Bessel function of the third kind of order zero for double precision argument X. The argument must be greater than zero but not so large that the result underflows. Series for BK0 on the interval 0. to 4.00000E+00
...
- Exact Netlib source: [DBESK0](https://www.netlib.org/slatec/fnlib/dbesk0.f)
...
significant figures required  32.05 decimal places required  33.11
...
Canonical Rust path: `slatec_sys::special::bessel::dbesk0`. Native symbol: `dbesk0_`. Declaration feature: `special`. Provider feature: `special-real`. ABI fingerprint: `function:f64(mut_f64)`.
