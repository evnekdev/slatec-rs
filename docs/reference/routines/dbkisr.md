...
DBKISR computes repeated integrals of the K0 Bessel function by the series for N=0,1, and 2.
...
- Canonical provider: `main-src/src/dbkisr.f` (`pinned-reproducible-subset`)
- Alternate providers:
  - `src/dbkisr.f` (`live-main-source`)

## Official references

- [Netlib source](https://www.netlib.org/slatec/src/dbkisr.f) — `verified_cached`
- [Netlib full source](https://www.netlib.org/cgi-bin/netlibfiles.pl?filename=/slatec/src/dbkisr.f) — `verified_cached`
...
| `N` | unavailable | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | DBKISR computes repeated integrals of the K0 Bessel function by the series for N=0,1, and 2. | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `SUM` | unavailable | `DOUBLE PRECISION` (`explicit`) | `*mut f64` | scalar | No separable argument description was found in the selected source prologue. | unavailable Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
