...
- Exact Netlib source: [SSPR](https://www.netlib.org/slatec/lin/sspr.f)
...
Canonical Rust path: `slatec_sys::blas::level2::sspr`. Native symbol: `sspr_`. Declaration feature: `blas-level2`. Provider feature: `blas-level2`. ABI fingerprint: `unavailable`.
