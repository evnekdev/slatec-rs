...
- Exact Netlib source: [CHER](https://www.netlib.org/slatec/lin/cher.f)
...
| 6 | `A` | `input-output` | `array` | `COMPLEX` | `*mut crate::Complex32` | rank 2; dimensions (LDA, *) | Array argument classified by fixed-form executable read/write analysis. |
...
Canonical Rust path: `slatec_sys::blas::level2::cher`. Native symbol: `cher_`. Declaration feature: `blas-level2`. Provider feature: `blas-level2`. ABI fingerprint: `unavailable`.
