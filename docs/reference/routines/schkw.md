...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `NAME` | output | `UNKNOWN` (`unknown`) | `UNKNOWN` | scalar | *Usage: CHARACTER*(*) NAME INTEGER LOCIW, LENIW, LOCW, LENW, IERR, ITER REAL ERR CALL SCHKW( NAME, LOCIW, LENIW, LOCW, LENW, IERR, ITER, ERR ) *Arguments: NAME :IN Character*(*). | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
| `LOCIW` | output | `INTEGER` (`explicit`) | `*mut crate::FortranInteger` | scalar | *Usage: CHARACTER*(*) NAME INTEGER LOCIW, LENIW, LOCW, LENW, IERR, ITER REAL ERR CALL SCHKW( NAME, LOCIW, LENIW, LOCW, LENW, IERR, ITER, ERR ) *Arguments: NAME :IN Character*(*). | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
...
| `ERR` | output | `REAL` (`explicit`) | `*mut f32` | scalar | *Usage: CHARACTER*(*) NAME INTEGER LOCIW, LENIW, LOCW, LENW, IERR, ITER REAL ERR CALL SCHKW( NAME, LOCIW, LENIW, LOCW, LENW, IERR, ITER, ERR ) *Arguments: NAME :IN Character*(*). | none stated in the separable source sentence Leading dimension: not established Workspace: not established | required; null is not permitted for an ordinary Fortran actual argument |
