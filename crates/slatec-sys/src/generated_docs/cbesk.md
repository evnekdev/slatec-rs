...
This canonical unsafe binding exposes original SLATEC routine `CBESK`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [CBESK](https://www.netlib.org/slatec/src/cbesk.f).
...
- Original SLATEC routine: `CBESK`
- Native symbol: `cbesk_`
- ABI fingerprint: `subroutine:void(mut_complex32,mut_f32,mut_i32,mut_i32,mut_complex32_array_rank1,mut_i32,mut_i32)`
- Exact Netlib source file: [CBESK](https://www.netlib.org/slatec/src/cbesk.f)
