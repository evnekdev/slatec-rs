...
(input) real*8 array of points at which the functions are to be evaluated. If any of the XE are outside the interval \[X1,X2\], a warning error is returned in NEXT.
...
CALL DCHFDV (X1,X2, F1,F2, D1,D2, NE, XE, FE, DE, NEXT, IERR) (output) real*8 array of values of the first derivative of the same function at the points XE.
