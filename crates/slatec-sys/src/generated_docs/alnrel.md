...
input `scalar` argument; Fortran declaration `REAL`, Rust ABI type `*mut f32`, and scalar. evaluates ln(1+X) accurately in the sense of relative not stated by selected source not applicable or not stated by selected source not a workspace argument
