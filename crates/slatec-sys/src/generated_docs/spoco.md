...
This canonical unsafe binding exposes original SLATEC routine `SPOCO`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SPOCO](https://www.netlib.org/slatec/lin/spoco.f).
...
- Original SLATEC routine: `SPOCO`
- Native symbol: `spoco_`
- ABI fingerprint: `subroutine:void(mut_f32_ptr_rank2,mut_i32,mut_i32,mut_f32,mut_f32_ptr_rank1,mut_i32)`
- Exact Netlib source file: [SPOCO](https://www.netlib.org/slatec/lin/spoco.f)
