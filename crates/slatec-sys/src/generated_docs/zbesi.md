...
This canonical unsafe binding exposes original SLATEC routine `ZBESI`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [ZBESI](https://www.netlib.org/slatec/src/zbesi.f).
...
- Original SLATEC routine: `ZBESI`
- Native symbol: `zbesi_`
...
- Exact Netlib source file: [ZBESI](https://www.netlib.org/slatec/src/zbesi.f)
