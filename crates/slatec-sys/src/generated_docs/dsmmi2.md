...
This canonical unsafe binding exposes original SLATEC routine `DSMMI2`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DSMMI2](https://www.netlib.org/slatec/lin/dsmmi2.f).
...
Double Precision X(N). Solution of (L*D*U)(L*D*U)trans x = b.
...
- Original SLATEC routine: `DSMMI2`
- Native symbol: `dsmmi2_`
...
- Exact Netlib source file: [DSMMI2](https://www.netlib.org/slatec/lin/dsmmi2.f)
