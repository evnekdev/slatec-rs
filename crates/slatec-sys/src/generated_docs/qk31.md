...
This canonical unsafe binding exposes original SLATEC routine `QK31`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [QK31](https://www.netlib.org/slatec/src/qk31.f).
...
input-output `scalar` argument; Fortran declaration `REAL`, Rust ABI type `*mut f32`, and scalar. Real Estimate of the modulus of the modulus, which should not exceed ABS(I-RESULT) not stated by selected source not applicable or not stated by selected source not a workspace argument
...
- Original SLATEC routine: `QK31`
- Native symbol: `qk31_`
- ABI fingerprint: `subroutine:void(fn:f32(ref_f32),mut_f32,mut_f32,mut_f32,mut_f32,mut_f32,mut_f32)`
- Exact Netlib source file: [QK31](https://www.netlib.org/slatec/src/qk31.f)
