...
This canonical unsafe binding exposes original SLATEC routine `DSLUBC`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DSLUBC](https://www.netlib.org/slatec/lin/dslubc.f).
...
- Original SLATEC routine: `DSLUBC`
- Native symbol: `dslubc_`
...
- Exact Netlib source file: [DSLUBC](https://www.netlib.org/slatec/lin/dslubc.f)
