...
This canonical unsafe binding exposes original SLATEC routine `DQK41`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DQK41](https://www.netlib.org/slatec/src/dqk41.f).
...
- Original SLATEC routine: `DQK41`
- Native symbol: `dqk41_`
- ABI fingerprint: `subroutine:void(fn:f64(ref_f64),mut_f64,mut_f64,mut_f64,mut_f64,mut_f64,mut_f64)`
- Exact Netlib source file: [DQK41](https://www.netlib.org/slatec/src/dqk41.f)
