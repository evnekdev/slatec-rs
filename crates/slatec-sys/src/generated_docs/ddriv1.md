...
This canonical unsafe binding exposes original SLATEC routine `DDRIV1`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DDRIV1](https://www.netlib.org/slatec/src/ddriv1.f).
...
- Original SLATEC routine: `DDRIV1`
- Native symbol: `ddriv1_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [DDRIV1](https://www.netlib.org/slatec/src/ddriv1.f)
