...
input `scalar` argument; Fortran declaration `REAL`, Rust ABI type `*mut f32`, and scalar. calculates the Bessel function of the second kind of order one for real argument X. Series for BY1        on the interval  0.          to  1.60000D+01 with weighted error   1.87E-18 log weighted error  17.73 significant figures required  17.83 decimal places required  18.30 Series for BM1        on the interval  0.          to  6.25000D-02 with weighted error   5.61E-17 log weighted error  16.25 significant figures required  14.97 decimal places required  16.91 Series for BTH1       on the interval  0.          to  6.25000D-02 with weighted error   4.10E-17 log weighted error  16.39 significant figures required  15.96 decimal places required  17.08 not stated by selected source not applicable or not stated by selected source not a workspace argument
