...
This canonical unsafe binding exposes original SLATEC routine `SSLI`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SSLI](https://www.netlib.org/slatec/lin/ssli.f).
...
- Exact Netlib source file: [SSLI](https://www.netlib.org/slatec/lin/ssli.f)
