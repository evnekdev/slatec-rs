...
input `scalar` argument; Fortran declaration `COMPLEX`, Rust ABI type `*mut crate::Complex32`, and scalar. calculates the complete gamma function for COMPLEX argument Z.  This is a preliminary version that is portable but not accurate. not stated by selected source not applicable or not stated by selected source not a workspace argument
