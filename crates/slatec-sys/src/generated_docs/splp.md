...
This canonical unsafe binding exposes original SLATEC routine `SPLP`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SPLP](https://www.netlib.org/slatec/src/splp.f).
...
- Original SLATEC routine: `SPLP`
- Native symbol: `splp_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [SPLP](https://www.netlib.org/slatec/src/splp.f)
