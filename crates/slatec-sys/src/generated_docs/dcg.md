...
This canonical unsafe binding exposes original SLATEC routine `DCG`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DCG](https://www.netlib.org/slatec/lin/dcg.f).
...
- Exact Netlib source file: [DCG](https://www.netlib.org/slatec/lin/dcg.f)
