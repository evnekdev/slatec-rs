...
This canonical unsafe binding exposes original SLATEC routine `SDSDOT`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SDSDOT](https://www.netlib.org/slatec/lin/sdsdot.f).
...
- Native symbol: `sdsdot_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [SDSDOT](https://www.netlib.org/slatec/lin/sdsdot.f)
