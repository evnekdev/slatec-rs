...
This canonical unsafe binding exposes original SLATEC routine `DRC3JM`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DRC3JM](https://www.netlib.org/slatec/src/drc3jm.f).
...
- Original SLATEC routine: `DRC3JM`
- Native symbol: `drc3jm_`
- ABI fingerprint: `subroutine:void(mut_f64,mut_f64,mut_f64,mut_f64,mut_f64,mut_f64,mut_f64_ptr_rank1,mut_i32,mut_i32)`
- Exact Netlib source file: [DRC3JM](https://www.netlib.org/slatec/src/drc3jm.f)
