...
Integer. Length of the double precision workspace, RWORK. NL+5*N. NL is the number of non-zeros in the lower triangle of the matrix (including the diagonal).
