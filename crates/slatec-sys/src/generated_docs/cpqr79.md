...
This canonical unsafe binding exposes original SLATEC routine `CPQR79`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [CPQR79](https://www.netlib.org/slatec/src/cpqr79.f).
...
- Original SLATEC routine: `CPQR79`
- Native symbol: `cpqr79_`
- ABI fingerprint: `subroutine:void(mut_i32,mut_complex32_array_rank1,mut_complex32_array_rank1,mut_i32,mut_f32_array_rank1)`
- Exact Netlib source file: [CPQR79](https://www.netlib.org/slatec/src/cpqr79.f)
