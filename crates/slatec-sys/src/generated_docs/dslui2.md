...
This canonical unsafe binding exposes original SLATEC routine `DSLUI2`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DSLUI2](https://www.netlib.org/slatec/lin/dslui2.f).
...
Double Precision X(N). Solution of L*D*U x = b.
...
- Original SLATEC routine: `DSLUI2`
- Native symbol: `dslui2_`
...
- Exact Netlib source file: [DSLUI2](https://www.netlib.org/slatec/lin/dslui2.f)
