...
This canonical unsafe binding exposes original SLATEC routine `LLSIA`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [LLSIA](https://www.netlib.org/slatec/src/llsia.f).
...
- Original SLATEC routine: `LLSIA`
- Native symbol: `llsia_`
...
- Exact Netlib source file: [LLSIA](https://www.netlib.org/slatec/src/llsia.f)
