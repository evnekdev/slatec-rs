...
NON-ADAPTIVE INTEGRATION STANDARD FORTRAN SUBROUTINE DOUBLE PRECISION VERSION

# Description

This canonical unsafe binding exposes original SLATEC routine `DQNG`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DQNG](https://www.netlib.org/slatec/src/dqng.f).
...
- Original SLATEC routine: `DQNG`
- Native symbol: `dqng_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [DQNG](https://www.netlib.org/slatec/src/dqng.f)
