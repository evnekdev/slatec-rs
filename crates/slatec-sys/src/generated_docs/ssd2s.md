...
This canonical unsafe binding exposes original SLATEC routine `SSD2S`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SSD2S](https://www.netlib.org/slatec/lin/ssd2s.f).
...
- Original SLATEC routine: `SSD2S`
- Native symbol: `ssd2s_`
...
- Exact Netlib source file: [SSD2S](https://www.netlib.org/slatec/lin/ssd2s.f)
