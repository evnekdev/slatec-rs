...
This canonical unsafe binding exposes original SLATEC routine `QK61`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [QK61](https://www.netlib.org/slatec/src/qk61.f).
...
- Original SLATEC routine: `QK61`
- Native symbol: `qk61_`
- ABI fingerprint: `subroutine:void(fn:f32(ref_f32),mut_f32,mut_f32,mut_f32,mut_f32,mut_f32,mut_f32)`
- Exact Netlib source file: [QK61](https://www.netlib.org/slatec/src/qk61.f)
