...
This canonical unsafe binding exposes original SLATEC routine `DGBMV`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DGBMV](https://www.netlib.org/slatec/lin/dgbmv.f).
...
- Native symbol: `dgbmv_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [DGBMV](https://www.netlib.org/slatec/lin/dgbmv.f)
