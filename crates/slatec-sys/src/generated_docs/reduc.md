...
This canonical unsafe binding exposes original SLATEC routine `REDUC`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [REDUC](https://www.netlib.org/slatec/lin/reduc.f).
...
- Original SLATEC routine: `REDUC`
- Native symbol: `reduc_`
- ABI fingerprint: `subroutine:void(mut_i32,mut_i32,mut_f32_ptr_rank2,mut_f32_ptr_rank2,mut_f32_ptr_rank1,mut_i32)`
- Exact Netlib source file: [REDUC](https://www.netlib.org/slatec/lin/reduc.f)
