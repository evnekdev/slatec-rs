...
This canonical unsafe binding exposes original SLATEC routine `DERKF`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DERKF](https://www.netlib.org/slatec/src/derkf.f).
...
This is a value of the independent variable.

## `Y`

**Direction:** `input-output`. **Fortran type:** `REAL`. **Rust ABI type:** `*mut f32`. **Shape:** rank 1; dimensions (*).

This array contains the solution components at T.

## `TOUT`

**Direction:** `input`. **Fortran type:** `REAL`. **Rust ABI type:** `*mut f32`. **Shape:** scalar.

This is a point at which a solution is desired.
...
These quantities represent relative and absolute error tolerances which you provide to indicate how accurately you wish the solution to be computed. You may choose them to be both scalars or else both vectors.
...
RWORK(*) is a REAL work array of length LRW which provides the code with needed storage space.
...
These are REAL and INTEGER parameter arrays which you can use for communication between your calling program and the F subroutine.
...
- Original SLATEC routine: `DERKF`
- Native symbol: `derkf_`
- ABI fingerprint: `subroutine:void(sub:void(mut_f32,mut_f32,mut_f32,mut_f32,mut_i32),mut_i32,mut_f32,mut_f32_ptr_rank1,mut_f32,mut_i32_ptr_rank1,mut_f32_ptr_rank1,mut_f32_ptr_rank1,mut_i32,mut_f32_ptr_rank1,mut_i32,mut_i32_ptr_rank1,mut_i32,mut_f32_ptr_rank1,mut_i32_ptr_rank1)`
- Exact Netlib source file: [DERKF](https://www.netlib.org/slatec/src/derkf.f)
