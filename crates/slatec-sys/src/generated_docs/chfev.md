...
(input) real array of points at which the function is to be evaluated. If any of the XE are outside the interval \[X1,X2\], a warning error is returned in NEXT.
