...
This canonical unsafe binding exposes original SLATEC routine `CGBMV`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [CGBMV](https://www.netlib.org/slatec/lin/cgbmv.f).
...
- Native symbol: `cgbmv_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [CGBMV](https://www.netlib.org/slatec/lin/cgbmv.f)
