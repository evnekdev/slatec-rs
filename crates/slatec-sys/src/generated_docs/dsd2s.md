...
This canonical unsafe binding exposes original SLATEC routine `DSD2S`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DSD2S](https://www.netlib.org/slatec/lin/dsd2s.f).
...
- Original SLATEC routine: `DSD2S`
- Native symbol: `dsd2s_`
...
- Exact Netlib source file: [DSD2S](https://www.netlib.org/slatec/lin/dsd2s.f)
