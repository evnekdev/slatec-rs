...
This canonical unsafe binding exposes original SLATEC routine `DDRIV2`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DDRIV2](https://www.netlib.org/slatec/src/ddriv2.f).
...
- Original SLATEC routine: `DDRIV2`
- Native symbol: `ddriv2_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [DDRIV2](https://www.netlib.org/slatec/src/ddriv2.f)
