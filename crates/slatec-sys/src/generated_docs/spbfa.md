...
This canonical unsafe binding exposes original SLATEC routine `SPBFA`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SPBFA](https://www.netlib.org/slatec/lin/spbfa.f).
...
- Original SLATEC routine: `SPBFA`
- Native symbol: `spbfa_`
- ABI fingerprint: `subroutine:void(mut_f32_ptr_rank2,mut_i32,mut_i32,mut_i32,mut_i32)`
- Exact Netlib source file: [SPBFA](https://www.netlib.org/slatec/lin/spbfa.f)
