...
This canonical unsafe binding exposes original SLATEC routine `SBOLS`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SBOLS](https://www.netlib.org/slatec/src/sbols.f).
...
- Original SLATEC routine: `SBOLS`
- Native symbol: `sbols_`
- ABI fingerprint: `subroutine:void(mut_f32_ptr_rank2,mut_i32,mut_i32,mut_i32,mut_f32_ptr_rank1,mut_f32_ptr_rank1,mut_i32_ptr_rank1,mut_i32_ptr_rank1,mut_f32_ptr_rank1,mut_f32,mut_i32,mut_f32_ptr_rank1,mut_i32_ptr_rank1)`
- Exact Netlib source file: [SBOLS](https://www.netlib.org/slatec/src/sbols.f)
