...
This canonical unsafe binding exposes original SLATEC routine `DQK15I`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DQK15I](https://www.netlib.org/slatec/src/dqk15i.f).
...
- Original SLATEC routine: `DQK15I`
- Native symbol: `dqk15i_`
- ABI fingerprint: `subroutine:void(fn:f64(ref_f64),mut_f64,mut_i32,mut_f64,mut_f64,mut_f64,mut_f64,mut_f64,mut_f64)`
- Exact Netlib source file: [DQK15I](https://www.netlib.org/slatec/src/dqk15i.f)
