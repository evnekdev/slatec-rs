...
INTEGER the order of the matrix A. N must be greater than or equal to 1. (terminal error message IND=-2) where NC = 2*ML+MU+1.
...
REAL(N*(NC+1)) a singly subscripted array of dimension at least.
