...
This canonical unsafe binding exposes original SLATEC routine `SSPR2`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SSPR2](https://www.netlib.org/slatec/lin/sspr2.f).
...
- Native symbol: `sspr2_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [SSPR2](https://www.netlib.org/slatec/lin/sspr2.f)
