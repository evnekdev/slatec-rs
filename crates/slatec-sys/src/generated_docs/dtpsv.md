...
This canonical unsafe binding exposes original SLATEC routine `DTPSV`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DTPSV](https://www.netlib.org/slatec/lin/dtpsv.f).
...
- Native symbol: `dtpsv_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [DTPSV](https://www.netlib.org/slatec/lin/dtpsv.f)
