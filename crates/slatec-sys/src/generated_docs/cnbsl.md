...
This canonical unsafe binding exposes original SLATEC routine `CNBSL`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [CNBSL](https://www.netlib.org/slatec/src/cnbsl.f).
...
- Original SLATEC routine: `CNBSL`
- Native symbol: `cnbsl_`
...
- Exact Netlib source file: [CNBSL](https://www.netlib.org/slatec/src/cnbsl.f)
