...
This canonical unsafe binding exposes original SLATEC routine `DPPQAD`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DPPQAD](https://www.netlib.org/slatec/src/dppqad.f).
...
- Original SLATEC routine: `DPPQAD`
- Native symbol: `dppqad_`
- ABI fingerprint: `subroutine:void(mut_i32,mut_f64_ptr_rank2,mut_f64_ptr_rank1,mut_i32,mut_i32,mut_f64,mut_f64,mut_f64)`
- Exact Netlib source file: [DPPQAD](https://www.netlib.org/slatec/src/dppqad.f)
