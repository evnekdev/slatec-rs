...
This canonical unsafe binding exposes original SLATEC routine `SGEMM`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SGEMM](https://www.netlib.org/slatec/lin/sgemm.f).
...
- Native symbol: `sgemm_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [SGEMM](https://www.netlib.org/slatec/lin/sgemm.f)
