...
This canonical unsafe binding exposes original SLATEC routine `DQK15`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DQK15](https://www.netlib.org/slatec/src/dqk15.f).
...
- Original SLATEC routine: `DQK15`
- Native symbol: `dqk15_`
- ABI fingerprint: `subroutine:void(fn:f64(ref_f64),mut_f64,mut_f64,mut_f64,mut_f64,mut_f64,mut_f64)`
- Exact Netlib source file: [DQK15](https://www.netlib.org/slatec/src/dqk15.f)
