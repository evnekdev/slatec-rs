...
input `scalar` argument; Fortran declaration `REAL`, Rust ABI type `*mut f32`, and scalar. 1, -2, .... 1, -2, .... GAMMA and X are single precision. GAMMA and X are single precision. not stated by selected source not applicable or not stated by selected source not a workspace argument
