...
This canonical unsafe binding exposes original SLATEC routine `QAGS`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [QAGS](https://www.netlib.org/slatec/src/qags.f).
...
input `scalar` argument; Fortran declaration `REAL`, Rust ABI type `*mut f32`, and scalar. Real Lower limit of integration LIMIT.GE.1. not stated by selected source not applicable or not stated by selected source not a workspace argument
...
- Original SLATEC routine: `QAGS`
- Native symbol: `qags_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [QAGS](https://www.netlib.org/slatec/src/qags.f)
