...
Double Precision X(N). Initial guess that will be later used in the iterative solution. of the scaled system.
...
Double Precision DINV(N). Upon return this array holds 1. /DIAG(A). This is an input if JOB = 0.
