...
This canonical unsafe binding exposes original SLATEC routine `SCG`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SCG](https://www.netlib.org/slatec/lin/scg.f).
...
- Exact Netlib source file: [SCG](https://www.netlib.org/slatec/lin/scg.f)
