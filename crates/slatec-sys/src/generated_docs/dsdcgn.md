...
This canonical unsafe binding exposes original SLATEC routine `DSDCGN`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DSDCGN](https://www.netlib.org/slatec/lin/dsdcgn.f).
...
- Original SLATEC routine: `DSDCGN`
- Native symbol: `dsdcgn_`
...
- Exact Netlib source file: [DSDCGN](https://www.netlib.org/slatec/lin/dsdcgn.f)
