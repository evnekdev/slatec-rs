...
workspace `workspace` argument; Fortran declaration `DOUBLE PRECISION`, Rust ABI type `*mut f64`, and rank 1; dimensions (*). DOUBLE PRECISION. is a work array. not stated by selected source not applicable or not stated by selected source
...
- Original SLATEC routine: `DCHDC`
- Native symbol: `dchdc_`
- ABI fingerprint: `subroutine:void(mut_f64_ptr_rank2,mut_i32,mut_i32,mut_f64_ptr_rank1,mut_i32_ptr_rank1,mut_i32,mut_i32)`
- Exact Netlib source file: [DCHDC](https://www.netlib.org/slatec/lin/dchdc.f)
