...
This canonical unsafe binding exposes original SLATEC routine `SSLUI4`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SSLUI4](https://www.netlib.org/slatec/lin/sslui4.f).
...
X(N). Solution of (L*D*U)trans x = b.
...
- Original SLATEC routine: `SSLUI4`
- Native symbol: `sslui4_`
...
- Exact Netlib source file: [SSLUI4](https://www.netlib.org/slatec/lin/sslui4.f)
