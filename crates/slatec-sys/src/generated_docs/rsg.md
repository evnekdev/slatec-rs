...
This canonical unsafe binding exposes original SLATEC routine `RSG`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [RSG](https://www.netlib.org/slatec/lin/rsg.f).
...
- Exact Netlib source file: [RSG](https://www.netlib.org/slatec/lin/rsg.f)
