...
This canonical unsafe binding exposes original SLATEC routine `SSLUBC`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [SSLUBC](https://www.netlib.org/slatec/lin/sslubc.f).
...
- Original SLATEC routine: `SSLUBC`
- Native symbol: `sslubc_`
...
- Exact Netlib source file: [SSLUBC](https://www.netlib.org/slatec/lin/sslubc.f)
