...
X(N). On input X is your initial guess for solution vector. On output X is the final approximate solution. D (B - LX - UX ).
...
Integer. Length of the real workspace, RWORK. LENW >= 4*N.
