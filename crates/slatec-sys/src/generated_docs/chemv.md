...
input `array` argument; Fortran declaration `COMPLEX`, Rust ABI type `*mut crate::Complex32`, and rank 2; dimensions (LDA, *). is an n by n hermitian matrix. Parameters ========== COMPLEX          array of DIMENSION ( LDA, n ). is an n by n hermitian matrix. Parameters ========== COMPLEX          array of DIMENSION ( LDA, n ). not applicable or not stated by selected source not a workspace argument
...
- Native symbol: `chemv_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [CHEMV](https://www.netlib.org/slatec/lin/chemv.f)
