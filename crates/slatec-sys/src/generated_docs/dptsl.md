...
This canonical unsafe binding exposes original SLATEC routine `DPTSL`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DPTSL](https://www.netlib.org/slatec/lin/dptsl.f).
...
- Original SLATEC routine: `DPTSL`
- Native symbol: `dptsl_`
- ABI fingerprint: `subroutine:void(mut_i32,mut_f64_ptr_rank1,mut_f64_ptr_rank1,mut_f64_ptr_rank1)`
- Exact Netlib source file: [DPTSL](https://www.netlib.org/slatec/lin/dptsl.f)
