...
This canonical unsafe binding exposes original SLATEC routine `DQAWCE`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [DQAWCE](https://www.netlib.org/slatec/src/dqawce.f).
...
- Original SLATEC routine: `DQAWCE`
- Native symbol: `dqawce_`
- ABI fingerprint: `subroutine:void(fn:f64(ref_f64),mut_f64,mut_f64,mut_f64,mut_f64,mut_f64,mut_i32,mut_f64,mut_f64,mut_i32,mut_i32,mut_f64_ptr_rank1,mut_f64_ptr_rank1,mut_f64_ptr_rank1,mut_f64_ptr_rank1,mut_i32_ptr_rank1,mut_i32)`
- Exact Netlib source file: [DQAWCE](https://www.netlib.org/slatec/src/dqawce.f)
