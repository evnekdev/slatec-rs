...
This canonical unsafe binding exposes original SLATEC routine `STPSV`. Its documented behavior is taken from the selected, source-hash-verified provider prologue; the exact implementation source is [STPSV](https://www.netlib.org/slatec/lin/stpsv.f).
...
- Native symbol: `stpsv_`
- ABI fingerprint: `unavailable`
- Exact Netlib source file: [STPSV](https://www.netlib.org/slatec/lin/stpsv.f)
