...
unsafe extern "C" {
    ...
    /// Supported ABI: GNU MinGW `x86_64-pc-windows-gnu`; ABI class `complex_argument_or_output`; fingerprint `subroutine:void(mut_i32,mut_complex32_array_rank1,mut_complex32_array_rank1,mut_i32,mut_f32_array_rank1)`.
...
unsafe extern "C" {
    ...
    /// Supported ABI: GNU MinGW `x86_64-pc-windows-gnu`; ABI class `complex_argument_or_output`; fingerprint `subroutine:void(mut_i32,mut_complex32_array_rank1,mut_complex32_array_rank1,mut_complex32_array_rank1,mut_i32,mut_f32_array_rank1)`.
    /// Complex values use `crate::Complex32` or `crate::Complex64` in real/imaginary order. Complex arguments are passed by pointer; complex function results use the compiler-probed direct aggregate-return convention.
    ///
    /// # Arguments
    ///
...
unsafe extern "C" {
    ...
    /// Supported ABI: GNU MinGW `x86_64-pc-windows-gnu`; ABI class `complex_argument_or_output`; fingerprint `subroutine:void(mut_i32,mut_f32_array_rank1,mut_complex32_array_rank1,mut_i32,mut_f32_array_rank1)`.
    /// Complex values use `crate::Complex32` or `crate::Complex64` in real/imaginary order. Complex arguments are passed by pointer; complex function results use the compiler-probed direct aggregate-return convention.
    ///
    /// # Arguments
    ///
...
unsafe extern "C" {
    ...
    /// Supported ABI: GNU MinGW `x86_64-pc-windows-gnu`; ABI class `complex_argument_or_output`; fingerprint `subroutine:void(mut_i32,mut_f32_array_rank1,mut_complex32_array_rank1,mut_complex32_array_rank1,mut_i32,mut_f32_array_rank1)`.
    /// Complex values use `crate::Complex32` or `crate::Complex64` in real/imaginary order. Complex arguments are passed by pointer; complex function results use the compiler-probed direct aggregate-return convention.
    ///
    /// # Arguments
    ///
