...
fn all_reaches_each_public_mathematical_family() {
    ...
    let _ = slatec_sys::fftpack::cffti1;
    let _ = slatec_sys::pde::fishpack::hwscrt;
    let _ = slatec_sys::pde::fishpack::pois3d;
    let _ = slatec_sys::linear_algebra::banded::dgbfa;
    let _ = slatec_sys::interpolation::dpchim;
    let _ = slatec_sys::interpolation::dbvalu;
    let _ = slatec_sys::interpolation::dppval;
}
