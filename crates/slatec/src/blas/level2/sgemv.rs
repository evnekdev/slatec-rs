...
/// `SGEMV`. Matrices are column-major and all dimensions, strides, and backing
...
pub fn sgemv(
    ...
    let mut transpose = transpose.real_character("sgemv")?;
...
/// Tightly packed, unit-stride convenience wrapper for [`sgemv`].
#[allow(clippy::too_many_arguments)]
pub fn sgemv_contiguous(
    transpose: Transpose,
    rows: usize,
    cols: usize,
    alpha: f32,
