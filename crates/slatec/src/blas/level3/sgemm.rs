...
/// routine `SGEMM`; stored shapes and column-major leading dimensions are
...
pub fn sgemm(
    ...
    let mut trans_a = trans_a.real_character("sgemm")?;
    let mut trans_b = trans_b.real_character("sgemm")?;
...
/// Tightly packed column-major convenience wrapper for [`sgemm`].
#[allow(clippy::too_many_arguments)]
pub fn sgemm_contiguous(
    trans_a: Transpose,
    trans_b: Transpose,
    m: usize,
    n: usize,
