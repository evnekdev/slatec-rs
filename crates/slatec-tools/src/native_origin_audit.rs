...
mod tests {
    ...
    fn checked_in_native_origin_evidence_is_complete_and_classifies_ier() {
        ...
        // Bulk raw batches widen the selected provider closure. The crosscheck
        // remains conservative for indirect external procedure references.
        assert_eq!(crosscheck["unresolved_count"].as_u64(), Some(118));
