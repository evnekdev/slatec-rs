...
pub fn generate(
    ...
    let files = [
        ...
        (
            ...
            json!({"schema_id":"slatec.safe-ode-sdrive.concurrency","schema_version":"1.0.0","snapshot_id":snapshot,"columns":["safe_function","native_routine","class","callback","XERROR","nested_policy","Send","Sync","reason"],"records":[["OdeSession<f32>::integrate_to","SDRIV3","SerializedGlobal","thread_local_context_under_runtime_lock","scoped_XGETF_XSETF_restoration","reject_active_context","conditional_on_callback","no","XERROR_and_thread_local_callback_dispatch_are_process_runtime_state"],["OdeSession<f64>::integrate_to","DDRIV3","SerializedGlobal","thread_local_context_under_runtime_lock","scoped_XGETF_XSETF_restoration","reject_active_context","conditional_on_callback","no","XERROR_and_thread_local_callback_dispatch_are_process_runtime_state"]]}),
        ),
        (
