...
pub fn generate(
    ...
    let files = [
        ...
        (
            ...
            json!({"schema_id":"slatec.safe-ode-sdrive.concurrency","schema_version":"1.1.0","snapshot_id":snapshot,"columns":["safe_function","native_routine","class","lock_scope","callback","XERROR","nested_policy","mutable_global_state_records","Send","Sync","reason"],"records":[["slatec::ode::OdeSession::<f32, F, E>::integrate_to","SDRIV3","SerializedGlobal","process_global","thread_local_context_under_runtime_lock","scoped_XGETF_XSETF_restoration","reject_active_context",["closure-incomplete-selected-provider","sdriv3-ddriv3-xerror-control","sdriv3-ddriv3-callback-context","sdstp-data-ier"],"conditional_on_callback","no","XERROR_and_thread_local_callback_dispatch_are_process_runtime_state"],["slatec::ode::OdeSession::<f64, F, E>::integrate_to","DDRIV3","SerializedGlobal","process_global","thread_local_context_under_runtime_lock","scoped_XGETF_XSETF_restoration","reject_active_context",["closure-incomplete-selected-provider","sdriv3-ddriv3-xerror-control","sdriv3-ddriv3-callback-context","ddstp-data-ier"],"conditional_on_callback","no","XERROR_and_thread_local_callback_dispatch_are_process_runtime_state"]]}),
        ),
        (
            "ode-sdrive-source-closure.json",
            json!({"schema_id":"slatec.safe-ode-sdrive.source-closure","schema_version":"1.0.0","snapshot_id":snapshot,"roots":["SDRIV3","DDRIV3"],"genuine_subsidiaries":["SDSTP","DDSTP","SDNTL","DDNTL","SDPSC","DDPSC","SDPST","DDPST","SDCOR","DDCOR","SDSCL","DDSCL","SDCST","DDCST","SDNTP","DDNTP","SDZRO","DDZRO","LINPACK_dense_banded","BLAS_level1","machine_constants","XERROR"],"unavoidable_co_retained_symbols":["SDNTP","DDNTP","SDZRO","DDZRO","dense_and_banded_LINPACK_paths"],"excluded":["DASSL","DEPAC","complex_SDRIVE","root_API","Jacobian_API","mass_matrix_API"]}),
        ),
        (
            "ode-sdrive-deferred.json",
            json!({"schema_id":"slatec.safe-ode-sdrive.deferred","schema_version":"1.0.0","snapshot_id":snapshot,"columns":["item","reason"],"records":[["SDRIV1_DDRIV1","convenience_driver_not_needed_for_owned_expert_session"],["SDRIV2_DDRIV2","root_callback_protocol_deferred"],["roots_and_events","NROOT_is_fixed_to_zero"],["analytic_and_finite_difference_Jacobians","MITER_is_fixed_to_zero"],["banded_Jacobians","matrix_view_and_layout_audit_deferred"],["mass_matrices_and_implicit_ODEs","IMPL_is_fixed_to_zero"],["SDASSL_DDASSL","DAE_consistency_and_residual_protocol_out_of_scope"],["dense_output_and_interpolation","NTASK_1_and_NSTATE_11_deferred"],["complex_SDRIVE","real_f32_f64_scope_only"],["session_clone_or_serialization","opaque_WORK_history_is_backend_specific"],["lock_free_or_family_lock_concurrency","runtime_is_process_serialized"],["ecosystem_adapters","core_API_uses_slices_and_Vec_without_dependencies"]]}),
        ),
    ];
